...
function normalizeStyle(value) {
  if (isArray$2(value)) {
    ...
    return res;
  } else if (isString$3(value) || isObject$6(value)) {
    return value;
  }
}
...
const toDisplayString$1 = (val) => {
  return isString$3(val) ? val : val == null ? "" : isArray$2(val) || isObject$6(val) && (val.toString === objectToString$2 || !isFunction$2(val.toString)) ? JSON.stringify(val, replacer, 2) : String(val);
};
...
function _createVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, isBlockNode = false) {
  ...
  const shapeFlag = isString$3(type) ? 1 : isSuspense(type) ? 128 : isTeleport(type) ? 64 : isObject$6(type) ? 4 : isFunction$2(type) ? 2 : 0;
...
var define_import_meta_env_default = { VITE_APP_EXSHIN_ROOT: "http://external-shops-integrator.dev2.k8s-local.cdek.ru/api/cms", BASE_URL: "/", MODE: "production", DEV: false, PROD: true, SSR: false };
const config = {
  map: {
...
const CdekSpinner = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render], ["__scopeId", "data-v-c4a93e36"]]);
...
const LoaderComponent = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["__scopeId", "data-v-00722d2b"]]);
/*!
* shared v9.10.1
...
function createMessageContext(options = {}) {
  ...
  const pluralRule = isObject$4(options.pluralRules) && isString$2(locale) && isFunction$1(options.pluralRules[locale]) ? options.pluralRules[locale] : pluralDefault;
  const orgPluralRule = isObject$4(options.pluralRules) && isString$2(locale) && isFunction$1(options.pluralRules[locale]) ? pluralDefault : void 0;
...
function fallbackWithSimple(ctx, fallback, start) {
  return [.../* @__PURE__ */ new Set([
    start,
    ...isArray$1(fallback) ? fallback : isObject$4(fallback) ? Object.keys(fallback) : isString$2(fallback) ? [fallback] : [start]
  ])];
}
...
function createCoreContext(options = {}) {
  ...
  const version2 = isString$2(options.version) ? options.version : VERSION$3;
...
const _hoisted_2$g = { class: "cdek-j8124d" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$j, [
        createBaseVNode("h1", _hoisted_2$g, toDisplayString$1(unref(t)("error")), 1)
      ]);
    };
  }
});
function block0$9(Component) {
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        "error": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Can't load map due to critical error" } }
      },
      "rus": {
        "error": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Произошла непредвиденная ошибка при загрузке карты" } }
      }
    }
  });
}
if (typeof block0$9 === "function")
  block0$9(_sfc_main$i);
const ErrorMessageComponent = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-7bb1c0db"]]);
var VueYandexMaps;
((VueYandexMaps2) => {
...
async function useYMapsLocationFromBounds({
  ...
  var _a;
  const ctxMap = Object.keys(map2).find((x) => x.endsWith("CtxMap"));
  if (!ctxMap) {
    throwException({
...
const _sfc_main$o = /* @__PURE__ */ defineComponent({
  ...
  setup(props, {
    ...
    const init = async () => {
      ...
      map2.value = new ymaps3.YMap(container, settings, [
        ...layers.value,
        ...props.layers
      ]);
      emit2("input", map2.value);
    ...
    onMounted(async () => {
      ...
      watch(() => props.cursorGrab, async (val) => {
        ...
        if (val) {
          ...
          map2.value.addChild(listener);
        } else if (listener)
          map2.value.removeChild(listener);
      }, { immediate: true });
      if (!VueYandexMaps.isLoaded.value) {
                  ...
                  onClick: async (e) => {
                    ...
                    if (clusterer.features.length >= 2) {
                      ...
                      if (settings.strategy === "boundsCorrect") {
                        ...
                        emit2("updatedBounds", updatedBounds);
                        (_c = map2.value) == null ? void 0 : _c.setLocation({
                        ...
                        (_d = map2.value) == null ? void 0 : _d.setLocation({
                          center,
                          zoom,
                          duration: defaultDuration,
                          easing: settings.easing
                        ...
                        if (map2.value)
                          emit2("updatedBounds", map2.value.bounds);
                      }
                    }
                  }
                }, item));
    ...
    return () => {
      ...
      if (version.startsWith("2")) {
        return h("div", [
          ...
          h(_sfc_main$3$1, {
            ...
            on: {
              trueBounds: (e) => emit2("trueBounds", e),
              updatedBounds: (e) => emit2("updatedBounds", e)
            },
            scopedSlots: {
              default: (options) => {
                var _a2;
      ...
      return h("div", [
        ...
        h(_sfc_main$3$1, {
          clusterMarkerProps: props.clusterMarkerProps,
          zoomOnClusterClick: props.zoomOnClusterClick,
          onTrueBounds: (e) => emit2("trueBounds", e),
          onUpdatedBounds: (e) => emit2("updatedBounds", e)
        }, {
          default: (options) => {
            var _a2;
...
const _hoisted_2$e = /* @__PURE__ */ createBaseVNode("path", {
  fill: "#4B3C87",
  d: "M28 14.344c0 2.788-.777 5.391-2.12 7.594C20.2 31.245 14 36 14 36S7.8 31.245 2.12 21.938A14.54 14.54 0 0 1 0 14.343C0 6.422 6.268 0 14 0s14 6.422 14 14.344"
}, null, -1);
...
const _hoisted_5$7 = /* @__PURE__ */ createBaseVNode("path", {
  ...
  "stroke-width": "1.2",
  d: "M8.667 15.333h10.667m-6.667-6.666v10.666m-4-7.333h4M10 8.667h8c.737 0 1.334.597 1.334 1.333v8c0 .736-.597 1.333-1.334 1.333h-8A1.333 1.333 0 0 1 8.667 18v-8c0-.736.597-1.333 1.333-1.333m4.667 2h2.667v2.666h-2.667z"
}, null, -1);
const _hoisted_6$4 = [
  _hoisted_2$e,
  _hoisted_3$d,
...
const SegmentedControl = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-1ce8e8cf"]]);
/*!
...
const _withScopeId$6 = (n) => (pushScopeId("data-v-bdfea597"), n = n(), popScopeId(), n);
const _hoisted_1$e = { class: "cdek-7b210z" };
const _hoisted_2$b = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("div", { class: "cdek-3kq5ny" }, null, -1));
...
function block0$8(Component) {
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        "hide": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Hide list" } },
        "pickup": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Postamat" } },
        "office": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Office" } }
      },
      "rus": {
        "hide": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Скрыть список" } },
        "pickup": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Постамат" } },
        "office": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Пункт выдачи" } }
      }
    }
  });
}
...
const MenuComponent = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-bdfea597"]]);
...
const CdekButton = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-e38dd0fe"]]);
const _withScopeId$5 = (n) => (pushScopeId("data-v-d3afac13"), n = n(), popScopeId(), n);
const _hoisted_1$d = { key: 0 };
const _hoisted_2$a = { class: "cdek-paz0c8" };
...
function block0$7(Component) {
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        "priceError": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "There was a problem during cost calculation" } },
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Select tariff" } },
        "days": { "t": 0, "b": { "t": 1, "c": [{ "t": 2, "i": [{ "t": 3 }], "s": "days" }, { "t": 2, "i": [{ "t": 3 }], "s": "day" }, { "t": 2, "i": [{ "t": 3 }], "s": "days" }] } },
        "select": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Select" } },
        "selected": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Selected" } }
      },
      "rus": {
        "priceError": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Не могу посчитать стоимость" } },
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Выберите тариф" } },
        "days": { "t": 0, "b": { "t": 1, "c": [{ "t": 2, "i": [{ "t": 3 }], "s": "дней" }, { "t": 2, "i": [{ "t": 3 }], "s": "день" }, { "t": 2, "i": [{ "t": 3 }], "s": "дня" }, { "t": 2, "i": [{ "t": 3 }], "s": "дней" }] } },
        "select": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Выбрать" } },
        "selected": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Выбран" } }
      }
    }
  });
}
...
const TariffInfo = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-d3afac13"]]);
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_1$c, [
          ...
          createBaseVNode("div", _hoisted_2$9, toDisplayString$1(unref(t)("title")), 1),
...
function block0$6(Component) {
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Delivery address" } },
        "needExactAddress": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Please, select exact address" } },
        "forbidden": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Delivery to that address is unavailable" } }
      },
      "rus": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Адрес доставки" } },
        "needExactAddress": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Выберите адрес точнее" } },
        "forbidden": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Доставка в выбранный адрес недоступна" } }
      }
    }
  });
}
...
const DoorExtendedInfo = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-6599109d"]]);
const _hoisted_1$b = { class: "cdek-qujp2c" };
const _hoisted_2$8 = { class: "cdek-1smek3" };
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        class: normalizeClass([{
          "cdek-i5n42d": !unref(coreStorage).openedPopups[unref(Popup).INFO] || unref(coreStorage).mode !== unref(DeliveryMode).OFFICE || !unref(mapStorage).exactOffice
        }, "cdek-dorbss"])
      }, [
        createBaseVNode("div", _hoisted_1$b, [
          ...
          createBaseVNode("div", _hoisted_2$8, toDisplayString$1(unref(t)(((_a = unref(mapStorage).exactOffice) == null ? void 0 : _a.type) === unref(OfficeType).OFFICE ? "title.office" : "title.pickup")) + " - " + toDisplayString$1((_b = unref(mapStorage).exactOffice) == null ? void 0 : _b.code), 1),
          createBaseVNode("div", _hoisted_3$7, toDisplayString$1((_c = unref(mapStorage).exactOffice) == null ? void 0 : _c.city) + ", " + toDisplayString$1((_d = unref(mapStorage).exactOffice) == null ? void 0 : _d.address), 1),
          createBaseVNode("div", _hoisted_4$6, [
            (openBlock(true), createElementBlock(Fragment, null, renderList((_f = (_e = unref(mapStorage).exactOffice) == null ? void 0 : _e.work_time) == null ? void 0 : _f.split(", "), (time, index) => {
              return openBlock(), createElementBlock("div", { key: index }, toDisplayString$1(time), 1);
            }), 128))
          ])
        ]),
        createVNode(TariffInfo, {
          tariffs: ((_g = unref(mapStorage).exactOffice) == null ? void 0 : _g.type) === unref(OfficeType).OFFICE ? unref(coreStorage).tariffs.office : unref(coreStorage).tariffs.pickup,
          class: "cdek-5mdqxp"
        }, null, 8, ["tariffs"])
      ], 2);
    };
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        ...
        "address": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Office address" } },
        "workingTime": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Office working time" } },
        "code": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Office code" } }
      },
      "rus": {
        "title": {
          "office": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Пункт выдачи" } },
        ...
        "address": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Адрес пункта выдачи заказов" } },
        "workingTime": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Время работы" } },
        "code": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Код ПВЗ" } }
      }
    }
  });
}
...
const OfficeExtendedInfo = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-14fc1ce9"]]);
const _withScopeId$4 = (n) => (pushScopeId("data-v-5ae9f56c"), n = n(), popScopeId(), n);
const _hoisted_1$a = {
  key: 0,
  class: "cdek-4zstr5"
};
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", {
          ...
          createBaseVNode("div", { onClick: openSearchField }, [
            unref(searchStorage).loading ? (openBlock(), createElementBlock("div", _hoisted_1$a)) : (openBlock(), createElementBlock("div", _hoisted_2$7))
          ]),
          createBaseVNode("div", {
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        ...
        "notFound": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Nothing found" } },
        "loading": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Searching..." } },
        "office": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "CDEK Office" } },
        "region": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Region at the map" } },
        "door": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Delivery address" } },
        "title": {
          "door": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Delivery address" } },
          "office": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Search" } }
        }
      },
      "rus": {
        "title": {
          "door": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Поиск адреса" } },
          "office": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Поиск" } }
        },
        "clear": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Очистить" } },
        "notFound": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Ничего не найдено" } },
        "loading": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Выполняется поиск..." } },
        "office": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Пункт СДЭК" } },
        "region": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Область на карте" } },
        "door": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Адрес доставки" } }
      }
    }
  });
}
...
const SearchComponent = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-5ae9f56c"]]);
const _withScopeId$3 = (n) => (pushScopeId("data-v-6014ea9d"), n = n(), popScopeId(), n);
...
function block0$3(Component) {
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        "hint": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Support" } },
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Support service" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "If you have any questions, you can ask them to our specialists" } }
      },
      "rus": {
        "hint": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Поддержка" } },
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Служба поддержки" } },
        "text": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Если у вас есть вопросы, можете задать их нашим специалистам" } }
      }
    }
  });
}
...
const SupportComponent = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-6014ea9d"]]);
...
const CheckboxItem = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-2bfa0d34"]]);
...
const RadioButton = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-70e772ab"]]);
const _hoisted_1$6 = { class: "cdek-lelauu" };
const _hoisted_2$4 = { class: "cdek-7bgzk4" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$6, [
        createBaseVNode("h1", _hoisted_2$4, toDisplayString$1(unref(t)("title")), 1),
...
function block0$2(Component) {
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        "hint": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Open filters" } },
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Filters" } },
        "cashless": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Card payment" } },
        "cash": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Cash payment" } },
        "dress": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Have dressing room" } },
        "type": {
          "all": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "ALL" } },
          "office": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Offices only" } },
          "pickup": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Pickup points only" } }
        }
      },
      "rus": {
        "hint": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Открыть фильтры" } },
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Фильтры" } },
        "cashless": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Оплата картой" } },
        "cash": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Оплата наличными" } },
        "dress": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Есть примерочная" } },
        "type": {
          "all": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Все" } },
          "office": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Только ПВЗ" } },
          "pickup": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Только постаматы" } }
        }
      }
    }
  });
...
const FilterComponent = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-9b2a4cd5"]]);
...
const CdekInput = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-e4bdb538"]]);
const _withScopeId$2 = (n) => (pushScopeId("data-v-9bf0fdb3"), n = n(), popScopeId(), n);
const _hoisted_1$4 = { class: "cdek-3f9gze" };
const _hoisted_2$3 = { class: "cdek-d0hmb8" };
...
function block0$1(Component) {
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "It was not possible to determine the departure address index, please enter it manually" } },
        "label": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Postal code" } },
        "button": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Save" } }
      },
      "rus": {
        "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Не получилось определить индекс адреса отправления, введите его вручную" } },
        "label": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Почтовый индекс" } },
        "button": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Сохранить" } }
      }
    }
  });
}
...
const PostcodeRequestModal = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-9bf0fdb3"]]);
const _hoisted_1$3 = {
  key: 0,
  class: "cdek-4zstr5"
};
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        loading.value ? (openBlock(), createElementBlock("div", _hoisted_1$3)) : (openBlock(), createElementBlock("div", _hoisted_2$2))
      ]);
    };
  }
});
const GeolocationComponent = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-f19b9ffc"]]);
const _withScopeId$1 = (n) => (pushScopeId("data-v-2722de74"), n = n(), popScopeId(), n);
...
const ZoomComponent = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-2722de74"]]);
const _withScopeId = (n) => (pushScopeId("data-v-bafb6af1"), n = n(), popScopeId(), n);
const _hoisted_1$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "cdek-6gqbf8" }, null, -1));
const _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "cdek-w9smev" }, null, -1));
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createBaseVNode("div", {
          ...
          ref: root2,
          class: normalizeClass([{
            "opened-menu": unref(coreStorage).openedPopups[unref(Popup).MENU] || unref(coreStorage).openedPopups[unref(Popup).INFO] && (unref(mapStorage).pointInfo || unref(mapStorage).exactOffice)
          }, "cdek-qk4tbx"])
        }, [
          createVNode(unref(_sfc_main$o), {
            ...
            default: withCtx(() => [
              ...
              createVNode(unref(_sfc_main$d$1), { settings: { position: "bottom right", orientation: "vertical" } }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$c$1), null, {
                    default: withCtx(() => [
              ...
              createVNode(unref(_sfc_main$d$1), { settings: { position: "top left", orientation: "horizontal" } }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$c$1), null, {
                    default: withCtx(() => [
                  ...
                  !unref(coreStorage).params.hideFilters.have_cashless || !unref(coreStorage).params.hideFilters.have_cash || !unref(coreStorage).params.hideFilters.is_dressing_room || !unref(coreStorage).params.hideFilters.type ? (openBlock(), createBlock(unref(_sfc_main$c$1), {
                    key: 0,
                    class: "cdek-rez3tg",
                  ...
                  unref(coreStorage).openedPopups[unref(Popup).FILTERS] ? (openBlock(), createBlock(unref(_sfc_main$c$1), {
                    key: 1,
                    class: "cdek-alrio7"
                  }, {
                    default: withCtx(() => [
              ...
              createVNode(unref(_sfc_main$d$1), { settings: { position: "bottom left", orientation: "vertical" } }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$c$1), { class: "cdek-alrio7" }, {
                    default: withCtx(() => [
              ...
              unref(coreStorage).mode === unref(DeliveryMode).OFFICE ? (openBlock(), createBlock(unref(_sfc_main$d$1), {
                key: 0,
                settings: { position: "top right", orientation: "horizontal" }
              }, {
                default: withCtx(() => [
                  !unref(coreStorage).openedPopups[unref(Popup).MENU] ? (openBlock(), createBlock(unref(_sfc_main$c$1), {
                    key: 0,
                    class: "cdek-rez3tg",
              ...
              unref(coreStorage).mode === unref(DeliveryMode).OFFICE ? (openBlock(), createBlock(unref(_sfc_main$2$1), {
                key: 1,
                "grid-size": 64
              }, {
                ...
                default: withCtx(() => [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(mapStorage).packageSuitedOffices, (office) => {
                    return openBlock(), createBlock(unref(_sfc_main$g$1), {
                      key: office.code,
                      settings: {
              ...
              unref(mapStorage).exactPoint !== null && unref(coreStorage).mode === unref(DeliveryMode).DOOR ? (openBlock(), createBlock(unref(_sfc_main$g$1), {
                key: 2,
              ...
              unref(mapStorage).geolocation !== null ? (openBlock(), createBlock(unref(_sfc_main$g$1), {
                key: 3,
...
function block0(Component) {
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        "to": {
          "office": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Deliver to office" } },
          "door": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Delivery to door" } }
        },
        "from": {
          "office": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Deliver from office" } },
          "door": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Delivery from door" } }
        }
      },
      "rus": {
        "to": {
          "office": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Доставить в пункт выдачи" } },
          "door": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Доставить до двери" } }
        },
        "from": {
          "office": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Доставить от пункта выдачи" } },
          "door": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Доставить от двери" } }
        }
      }
    }
  });
...
if (typeof block0 === "function")
  block0(_sfc_main$2);
const MapComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-bafb6af1"]]);
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-bd584a4d"]]);
const _hoisted_1 = {
  key: 0,
  class: "cdek-o13fdj"
};
    ...
    return (_ctx, _cache) => {
      return unref(coreStorage).params.popup ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
        unref(coreStorage).globalPopup ? (openBlock(), createElementBlock("div", _hoisted_1, [
          createBaseVNode("div", {
            class: normalizeClass([{
              "cdek-w4z8qs": !unref(coreStorage).params.hideDeliveryOptions[unref(DeliveryMode).OFFICE] && !unref(coreStorage).params.hideDeliveryOptions[unref(DeliveryMode).DOOR]
            }, "cdek-fylsw1"])
          }, [
            createBaseVNode("a", {
              class: "cdek-pw1flc",
...
const app = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-335d247d"]]);
...
class CdekApi extends AbstractApi {
  ...
  async getOffices() {
    ...
    const offices = await this.fetchOfficePage(additionalParams, 1, 1).then((r) => {
      if (!(r.headers instanceof AxiosHeaders2) || !r.headers.has("x-total-elements")) {
        return Promise.all([this.fetchOfficePage(additionalParams, 0, null).then((r2) => r2.data)]);
      }
      return Promise.all(
        Array.from(
          {
            length: Math.ceil(parseInt(r.headers["x-total-elements"]) / officesPageSize)
          },
          (_e, i) => this.fetchOfficePage(additionalParams, i, officesPageSize).then((r2) => r2.data)
        )
      );
    }).then((o) => o.map((r) => typeof r === "string" ? JSON.parse(r) : r).flat()).then(this.formatOffices).catch((e) => {
      if (axios$1.isCancel(e)) {
        if (core().debug) {
...
class Widget {
  constructor(input) {
    ...
    this.app.use(pinia).use(i18n(this.params.lang)).use(
      createYmaps({
        ...
        lang: yandexLang,
        mapsScriptWaitDuration: 3e4,
        mapsRenderWaitDuration: 3e4
      })
    ).mount(this.div);
    this.init().then();
  }
  ...
  async init() {
    ...
    const searchStorage = search();
    if (coreStorage.debug) {
      console.debug("[CDEK] Widget initialization started", toRaw(coreStorage.params));
    }
    coreStorage.$patch({
      params: this.params,
    ...
    const debouncedPrice = debounce(async () => {
      ...
      const address = {
        address: coreStorage.mode === DeliveryMode.DOOR ? (_a = mapStorage.pointInfo) == null ? void 0 : _a.formatted : void 0,
        country_code: coreStorage.mode === DeliveryMode.DOOR ? (_b = mapStorage.pointInfo) == null ? void 0 : _b.country_code : void 0,
        postal_code: coreStorage.mode === DeliveryMode.DOOR ? (_c = mapStorage.pointInfo) == null ? void 0 : _c.postal_code : void 0,
        code: coreStorage.mode === DeliveryMode.OFFICE ? (_d = mapStorage.exactOffice) == null ? void 0 : _d.city_code : void 0
      };
      try {
      ...
      ({
        ...
        after(() => {
          ...
          if (store2.uiLoadLocksCounter > 0)
            return;
          if (store2.debug) {
            console.debug("[CDEK] Widget 3.9.6 has been loaded");
          }
