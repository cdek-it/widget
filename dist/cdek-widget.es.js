...
const hasOwn$1 = (val, key) => hasOwnProperty$5.call(val, key);
...
const toDisplayString$1 = (val) => {
  return isString$2(val) ? val : val == null ? "" : isArray$2(val) || isObject$6(val) && (val.toString === objectToString$2 || !isFunction$2(val.toString)) ? JSON.stringify(val, replacer, 2) : String(val);
};
const replacer = (_key, val) => {
  ...
  } else if (isObject$6(val) && !isArray$2(val) && !isPlainObject$3(val)) {
    return String(val);
  }
  return val;
};
...
function _createVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, isBlockNode = false) {
  ...
  const shapeFlag = isString$2(type) ? 1 : isSuspense(type) ? 128 : isTeleport(type) ? 64 : isObject$6(type) ? 4 : isFunction$2(type) ? 2 : 0;
...
const core = defineStore("core", () => {
  ...
  const debug = computed(
    () => !!params.debug || Object.prototype.hasOwnProperty.call(window, "sessionStorage") && window.sessionStorage.getItem("CdekDebug")
  );
...
const search = defineStore("search", () => {
  ...
  return { value, loading, filters, searchResults, hideFilters, showSearchField };
});
...
const map = defineStore("map", () => {
  ...
  const fixedBounds = ref(null);
  const fixedParams = ref({
    [YandexGeocoderKind.COUNTRY]: null,
    [YandexGeocoderKind.LOCALITY]: null,
    [YandexGeocoderKind.PROVINCE]: null
  });
  ...
  const packageSuitedOffices = computed(
    () => offices.value.filter((office) => {
      if (fixedBounds.value !== null && (office.location[0] < fixedBounds.value.lower[0] || office.location[1] < fixedBounds.value.lower[1] || office.location[0] > fixedBounds.value.upper[0] || office.location[1] > fixedBounds.value.upper[1] || fixedParams.value[YandexGeocoderKind.COUNTRY] !== null && office.country_code.toLowerCase() !== fixedParams.value[YandexGeocoderKind.COUNTRY] || fixedParams.value[YandexGeocoderKind.LOCALITY] !== null && office.city.toLowerCase() !== fixedParams.value[YandexGeocoderKind.LOCALITY] || fixedParams.value[YandexGeocoderKind.PROVINCE] !== null && office.region.toLowerCase() !== fixedParams.value[YandexGeocoderKind.PROVINCE])) {
        return false;
      }
      ...
      return coreStorage.params.goods.filter((parcel) => {
        if (parcel.weight < office.weight_min || office.weight_max > 0 && parcel.weight > office.weight_max) {
          return false;
        }
  ...
  const searchedOffices = computed(() => {
    if (searchStorage.value.length === 0)
      return [];
    const searchValue = searchStorage.value.toLowerCase();
    const result = [];
    for (const office of filteredOffices.value) {
      if (office.code.toLowerCase().indexOf(searchValue) !== -1 || office.name.toLowerCase().indexOf(searchValue) !== -1 || office.address.toLowerCase().indexOf(searchValue) !== -1) {
        result.push(office);
      }
    }
    return result;
  ...
  const customClick = (_updateObject, event) => {
    ...
    if (fixedBounds.value !== null && (event.coordinates[0] < fixedBounds.value.lower[0] || event.coordinates[1] < fixedBounds.value.lower[1] || event.coordinates[0] > fixedBounds.value.upper[0] || event.coordinates[1] > fixedBounds.value.upper[1])) {
      if (coreStorage.debug) {
        console.debug("[CDEK] User clicked outside of fixed bounds, doing nothing");
      }
      return;
    }
    searchStorage.loading = true;
...
const _hoisted_2$i = /* @__PURE__ */ createStaticVNode('<defs data-v-2ca4ad76><radialGradient id="paint0_angular_102_1932" cx="24" cy="0" r="48" gradientUnits="userSpaceOnUse" data-v-2ca4ad76><stop offset="0.177083" stop-color="currentColor" stop-opacity="0.5" data-v-2ca4ad76></stop><stop offset="1" stop-color="currentColor" stop-opacity="0" data-v-2ca4ad76></stop></radialGradient></defs><circle cx="24" cy="24" r="23" stroke="currentColor" stroke-opacity="0.1" stroke-width="2" data-v-2ca4ad76></circle><path fill-rule="evenodd" clip-rule="evenodd" d="M24 0C10.7452 0 0 10.7452 0 24C0 37.2548 10.7452 48 24 48V46C11.8497 46 2 36.1503 2 24C2 11.8497 11.8497 2 24 2V0Z" fill="url(#paint0_angular_102_1932)" data-v-2ca4ad76></path><circle cx="24" cy="1" r="1" fill="currentColor" data-v-2ca4ad76></circle><animateTransform from="0 0 0" to="360 0 0" attributeName="transform" type="rotate" repeatCount="indefinite" dur="1300ms" data-v-2ca4ad76></animateTransform>', 5);
const _hoisted_7$4 = [
  _hoisted_2$i
];
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1$l, _hoisted_7$4);
}
const CdekSpinner = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["render", _sfc_render], ["__scopeId", "data-v-2ca4ad76"]]);
const _hoisted_1$k = { class: "cdek-hlhf5b" };
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  __name: "MapLoader",
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$k, [
        createVNode(CdekSpinner)
      ]);
    };
  }
});
const LoaderComponent = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-3c8861b9"]]);
/*!
* shared v9.8.0
...
function createMessageContext(options = {}) {
  ...
  const pluralRule = isObject$4(options.pluralRules) && isString$1(locale) && isFunction$1(options.pluralRules[locale]) ? options.pluralRules[locale] : pluralDefault;
  const orgPluralRule = isObject$4(options.pluralRules) && isString$1(locale) && isFunction$1(options.pluralRules[locale]) ? pluralDefault : void 0;
...
function fallbackWithSimple(ctx, fallback, start) {
  return [.../* @__PURE__ */ new Set([
    start,
    ...isArray$1(fallback) ? fallback : isObject$4(fallback) ? Object.keys(fallback) : isString$1(fallback) ? [fallback] : [start]
  ])];
}
...
const _hoisted_1$j = { class: "cdek-6dauvy" };
const _hoisted_2$h = { class: "cdek-j8124d" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$j, [
        createBaseVNode("h1", _hoisted_2$h, toDisplayString$1(unref(t)("error")), 1)
      ]);
    };
  }
});
    ...
    "resource": {
      "eng": {
        "error": (ctx) => {
          ...
          return _normalize(["Can't load map due to critical error"]);
        }
      },
      "rus": {
        "error": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Произошла непредвиденная ошибка при загрузке карты"]);
        }
      }
    }
  });
...
if (typeof block0$9 === "function")
  block0$9(_sfc_main$l);
const ErrorMessageComponent = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__scopeId", "data-v-d087bfa4"]]);
...
const isDate$2 = (d) => d instanceof Date;
const isEmpty = (o) => Object.keys(o).length === 0;
const isObject$2 = (o) => o != null && typeof o === "object";
const hasOwnProperty$1 = (o, ...args) => Object.prototype.hasOwnProperty.call(o, ...args);
...
const diff = (lhs, rhs) => {
  ...
  return Object.keys(rhs).reduce((acc, key) => {
    ...
    if (isEmptyObject(difference) && !isDate$2(difference) && (isEmptyObject(lhs[key]) || !isEmptyObject(rhs[key])))
      return acc;
    acc[key] = difference;
    return acc;
  }, deletedValues);
...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  emits: {
    "input"(map2) {
      return !map2 || typeof ymaps3 === "undefined" || map2 instanceof ymaps3.YMap;
    },
    "update:modelValue"(map2) {
      return !map2 || typeof ymaps3 === "undefined" || map2 instanceof ymaps3.YMap;
    }
  },
  setup(props, {
    ...
    emit2("input", map2.value);
    emit2("update:modelValue", map2.value);
    ...
    onMounted(async () => {
      ...
      const setupWatcher = () => {
        ...
        watch(getSettings, (val) => {
          ...
          (_a = map2.value) == null ? void 0 : _a.update(updatedSettings);
        }, {
          deep: true
        });
      };
...
function deleteMapChild({
  ...
  if (children && !isMercator) {
    if (typeof (root2 == null ? void 0 : root2.value) === "object" && Array.isArray(root2.value)) {
      root2.value = root2.value.filter((x) => x !== children);
    } else {
      (_a = root2.value) == null ? void 0 : _a.removeChild(children);
    }
  } else if (root2.value && children && isMercator && "update" in root2.value) {
    root2.value.update({
      projection: void 0
    });
  }
...
async function setupMapChildren({
    ...
    onBeforeUnmount(() => {
      if (children.value) {
        deleteMapChild({
          ...
          isMercator,
          root: (mapRoot == null ? void 0 : mapRoot.value) ? mapRoot : map2
        });
      }
    });
  }
  ...
  if (!returnOnly && map2.value && !isMercator) {
    if (initPromises == null ? void 0 : initPromises.value) {
    ...
    if (typeof (mapRoot == null ? void 0 : mapRoot.value) === "object" && Array.isArray(mapRoot.value)) {
      ...
      ((mapRoot == null ? void 0 : mapRoot.value) || map2.value).addChild(children.value);
    }
  } else if (isLayer) {
    layers.value.push(children.value);
  } else if (isMercator && map2.value) {
    map2.value.update({
...
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  ...
  setup(props, {
    ...
    onMounted(async () => {
      ...
      emit2("input", mapListener);
      emit2("update:modelValue", mapListener);
    });
    return () => {
      var _a;
...
function getMarkerContainerProps({
  ...
  for (const [key, value] of Object.entries(attrs)) {
    const obj = key === "root" ? root2 : children;
    if (value.class) {
...
const _sfc_main$a$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(props, {
    ...
    onMounted(async () => {
      ...
      emit2("input", mapChildren.value);
      emit2("update:modelValue", mapChildren.value);
    });
    return () => {
      var _a;
...
const _hoisted_2$g = /* @__PURE__ */ createStaticVNode('<path fill="#1AB248" d="M28 14.344c0 2.788-.777 5.391-2.12 7.594C20.2 31.245 14 36 14 36S7.8 31.245 2.12 21.937A14.536 14.536 0 0 1 0 14.345C0 6.422 6.268 0 14 0s14 6.422 14 14.344Z"></path><rect width="22" height="22" x="3" y="3" fill="#fff" rx="11"></rect><path fill="#1AB248" fill-rule="evenodd" d="M20.794 17.624h-.814c.184.304.292.656.292 1.033 0 1.138-.969 2.065-2.16 2.065-1.19 0-2.16-.927-2.16-2.065 0-.377.108-.729.293-1.033h-2.564c.185.304.292.656.292 1.033 0 1.138-.968 2.065-2.159 2.065-1.19 0-2.16-.927-2.16-2.065 0-.377.108-.729.293-1.033h-.823a.53.53 0 0 1-.54-.516l-.01-7.124-1.75-1.674a.5.5 0 0 1 0-.73c.21-.201.554-.201.764 0l1.927 1.843c.008.007.01.016.016.024a.494.494 0 0 1 .059.083.485.485 0 0 1 .064.349l.01 6.712h11.13a.53.53 0 0 1 .54.517.53.53 0 0 1-.54.516Zm-8.98 0c-.595 0-1.08.463-1.08 1.033 0 .569.485 1.032 1.08 1.032.595 0 1.08-.463 1.08-1.032 0-.57-.485-1.033-1.08-1.033Zm5.218 1.033c0 .569.485 1.032 1.08 1.032.596 0 1.08-.463 1.08-1.032 0-.57-.484-1.033-1.08-1.033-.595 0-1.08.463-1.08 1.033Zm2.682-3.098h-8.476a.529.529 0 0 1-.54-.517V7.793c0-.285.242-.516.54-.516h4.805l3.671.02c.298 0 .54.231.54.516v7.23a.528.528 0 0 1-.54.516Zm-.54-7.23-3.131-.02v1.55a.528.528 0 0 1-.54.516.528.528 0 0 1-.54-.516v-1.55h-3.185v6.217h7.396V8.33Z" clip-rule="evenodd"></path><rect width="22" height="22" x="3" y="3" fill="#fff" rx="11"></rect><rect width="22" height="22" x="3" y="3" fill="#fff" rx="11"></rect><path stroke="#1AB248" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.2" d="M8 19h12M9.333 19V9.667L14.667 7v12m4 0v-6.667l-4-2.666M12 11v.007M12 13v.007M12 15v.007M12 17v.007"></path>', 6);
const _hoisted_8$4 = [
  _hoisted_2$g
];
function render$2(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1$i, [..._hoisted_8$4]);
}
const OfficeIcon = { render: render$2 };
const _hoisted_1$h = {
  xmlns: "http://www.w3.org/2000/svg",
  width: "28",
  height: "36",
...
const _hoisted_2$f = /* @__PURE__ */ createBaseVNode("path", {
  fill: "#4B3C87",
  d: "M28 14.344c0 2.788-.777 5.391-2.12 7.594C20.2 31.245 14 36 14 36S7.8 31.245 2.12 21.937A14.536 14.536 0 0 1 0 14.345C0 6.422 6.268 0 14 0s14 6.422 14 14.344Z"
}, null, -1);
...
const _hoisted_4$c = /* @__PURE__ */ createBaseVNode("rect", {
  width: "22",
  height: "22",
  x: "3",
  y: "3",
...
const _hoisted_5$7 = /* @__PURE__ */ createBaseVNode("path", {
  ...
  "stroke-width": "1.2",
  d: "M8.667 15.333h10.667m-6.667-6.666v10.666m-4-7.333h4M10 8.667h8c.737 0 1.334.597 1.334 1.333v8c0 .736-.597 1.333-1.334 1.333h-8A1.333 1.333 0 0 1 8.667 18v-8c0-.736.597-1.333 1.333-1.333Zm4.667 2h2.667v2.666h-2.667v-2.666Z"
}, null, -1);
const _hoisted_6$4 = [
  _hoisted_2$f,
  _hoisted_3$d,
...
function render$1(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1$h, [..._hoisted_6$4]);
}
const PickupIcon = { render: render$1 };
const _hoisted_1$g = {
  xmlns: "http://www.w3.org/2000/svg",
  width: "28",
  height: "36",
...
const _hoisted_3$c = /* @__PURE__ */ createBaseVNode("rect", {
  width: "22",
  height: "22",
  x: "3",
  y: "3",
...
const _hoisted_4$b = /* @__PURE__ */ createBaseVNode("path", {
  ...
  "stroke-linejoin": "round",
  "stroke-width": "1.4",
  d: "M14.667 14v.007M8 20h12M9.333 20V9.333A1.333 1.333 0 0 1 10.667 8h4m2.666 7v5M20 10.667h-4.667m0 0 2-2m-2 2 2 2"
}, null, -1);
const _hoisted_5$6 = [
  _hoisted_2$e,
  _hoisted_3$c,
...
const DoorIcon = { render };
const _hoisted_1$f = { class: "cdek-xvnk8x" };
const _hoisted_2$d = ["onClick"];
const _hoisted_3$b = ["checked", "value", "onInput"];
const _hoisted_4$a = { class: "cdek-pdfvml" };
const _hoisted_5$5 = { class: "cdek-qzbpbh" };
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(props.items, (segment, index) => {
          return openBlock(), createElementBlock("div", {
            ...
            class: normalizeClass([{
              "cdek-mfqq2r": index === selectedIndex.value,
              "cdek-fshz91": index !== selectedIndex.value
            }, "cdek-luckad"]),
            ...
            createBaseVNode("div", _hoisted_4$a, [
              createBaseVNode("label", _hoisted_5$5, toDisplayString$1(segment.label), 1)
            ])
          ], 10, _hoisted_2$d);
        }), 128))
      ]);
...
const SegmentedControl = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-7dd1fbe1"]]);
/*!
...
function processScrollDiff(i, axis, diff2, useScrollingClass, forceFireReachEvent) {
  ...
  processScrollDiff$1(i, diff2, fields, useScrollingClass, forceFireReachEvent);
}
function processScrollDiff$1(i, diff2, ref2, useScrollingClass, forceFireReachEvent) {
  ...
  if (i.reach[y] && (diff2 || forceFireReachEvent)) {
...
const _withScopeId$6 = (n) => (pushScopeId("data-v-13181cdc"), n = n(), popScopeId(), n);
const _hoisted_1$e = { class: "cdek-7b210z" };
const _hoisted_2$c = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("div", { class: "cdek-3kq5ny" }, null, -1));
const _hoisted_3$a = ["onClick"];
const _hoisted_4$9 = { class: "cdek-9ax2h3" };
const _hoisted_5$4 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("span", { class: "cdek-q4k1hq" }, null, -1));
const _hoisted_6$3 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("span", { class: "cdek-s1qo85" }, null, -1));
const _hoisted_7$3 = { class: "cdek-2ew9g8" };
const _hoisted_8$3 = { class: "cdek-2ew9g8" };
const _sfc_main$g = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(
      () => nextTick(() => {
        if (coreStorage.debug)
          console.debug("[CDEK] Initializing Menu Prefect Scrollbar");
        new PerfectScrollbar(scrollableMenu.value);
      })
    );
    const selectOffice = (point) => {
      if (coreStorage.debug)
        console.debug("[CDEK] Selected office from menu", point);
      if (coreStorage.debug)
        console.debug("[CDEK] Switching delivery mode to office");
      searchStorage.$patch({ showSearchField: false });
      mapStorage.$patch({ location: { center: point.location, zoom: YandexMapZoomVariants.HOME } });
      coreStorage.$patch({ mode: DeliveryMode.OFFICE, selectedTariff: null, selected: false });
      coreStorage.closePopups();
      mapStorage.$patch({ exactOffice: point });
      coreStorage.togglePopup(Popup.INFO);
    };
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass([{ "cdek-i5n42d": !unref(coreStorage).openedPopups[unref(Popup).MENU] }, "cdek-uv033b"])
      }, [
        createBaseVNode("div", _hoisted_1$e, [
          createBaseVNode("div", {
            class: "cdek-p9960d",
            onClick: _cache[0] || (_cache[0] = ($event) => unref(coreStorage).togglePopup(unref(Popup).MENU))
          }, [
            _hoisted_2$c,
            createBaseVNode("div", null, toDisplayString$1(unref(t)("hide")), 1)
          ])
        ]),
        createBaseVNode("div", {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(mapStorage).filteredOffices, (office) => {
            return openBlock(), createElementBlock("div", {
              key: office.code,
              class: "cdek-xej5pa",
              ...
              createBaseVNode("span", _hoisted_4$9, [
                office.type === unref(OfficeType).PICKUP ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  _hoisted_5$4,
                  createBaseVNode("span", null, toDisplayString$1(unref(t)("pickup")), 1)
                ], 64)) : office.type === unref(OfficeType).OFFICE ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                  _hoisted_6$3,
                  createBaseVNode("span", null, toDisplayString$1(unref(t)("office")), 1)
                ], 64)) : createCommentVNode("", true)
              ]),
              createBaseVNode("p", _hoisted_7$3, toDisplayString$1(office.address), 1),
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        "hide": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Hide list"]);
        },
        "pickup": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Postamat"]);
        },
        "office": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Office"]);
        }
      },
      "rus": {
        "hide": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Скрыть список"]);
        },
        "pickup": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Постамат"]);
        },
        "office": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Пункт выдачи"]);
        }
      }
    }
  });
...
if (typeof block0$8 === "function")
  block0$8(_sfc_main$g);
const MenuComponent = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-13181cdc"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        class: normalizeClass([{
          "cdek-b9aure": props.theme === "primary" && !props.disabled,
          "cdek-j30l3x": props.theme === "secondary" && !props.disabled,
          "cdek-hduxed": props.small,
          "cdek-cpsdxs": props.disabled
        }, "cdek-hmeecb cursor-pinter"]),
        type: "button"
      }, [
...
const CdekButton = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-00fecb65"]]);
const _withScopeId$5 = (n) => (pushScopeId("data-v-bef4e663"), n = n(), popScopeId(), n);
const _hoisted_1$d = { key: 0 };
const _hoisted_2$b = { class: "cdek-paz0c8" };
const _hoisted_3$9 = ["onClick"];
const _hoisted_4$8 = {
  key: 0,
  class: "cdek-0os0h6"
};
const _hoisted_5$3 = { class: "cdek-psbor4" };
const _hoisted_6$2 = {
  key: 1,
  class: "cdek-fjsxo0"
};
const _hoisted_7$2 = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ createBaseVNode("div", { class: "cdek-zghbpn" }, null, -1));
const _hoisted_8$2 = [
  _hoisted_7$2
];
const _hoisted_9$2 = {
...
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const showTariffs = computed(
      () => Array.isArray(coreStorage.params.goods) && coreStorage.params.goods.length && coreStorage.params.from !== null
    );
    onMounted(() => {
      nextTick(() => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        unref(coreStorage).params.sender || unref(coreStorage).params.canChoose && !showTariffs.value ? (openBlock(), createElementBlock("div", _hoisted_1$d, [
          createVNode(CdekButton, {
            small: true,
            theme: unref(coreStorage).selected ? "secondary" : "primary",
            onClick: selectPoint
          }, {
            default: withCtx(() => [
              createTextVNode(toDisplayString$1(unref(t)(unref(coreStorage).selected ? "selected" : "select")), 1)
            ]),
            _: 1
          }, 8, ["theme"])
        ])) : showTariffs.value ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
          createBaseVNode("div", _hoisted_2$b, toDisplayString$1(unref(t)("title")), 1),
          createBaseVNode("div", {
            ref_key: "scrollable",
            ref: scrollable,
            class: "cdek-sbj3ed"
          }, [
            _ctx.tariffs.length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(_ctx.tariffs, (tariff) => {
              return openBlock(), createElementBlock("div", {
                key: tariff.tariff_code,
                class: normalizeClass([{
                  "cdek-pog16f": unref(coreStorage).selectedTariff !== null && unref(coreStorage).selectedTariff.tariff_code === tariff.tariff_code
                }, "cdek-18beit"]),
                onClick: ($event) => selectTariff(tariff)
              }, [
                unref(coreStorage).selectedTariff !== null && unref(coreStorage).selectedTariff.tariff_code === tariff.tariff_code ? (openBlock(), createElementBlock("i", _hoisted_4$8)) : createCommentVNode("", true),
                ...
                createBaseVNode("div", _hoisted_5$3, [
                  createBaseVNode("div", null, [
                    ...
                    createTextVNode(" " + toDisplayString$1(tariff.period_max) + " " + toDisplayString$1(unref(t)("days", tariff.period_max)), 1)
                  ]),
                  createBaseVNode("div", null, toDisplayString$1(tariff.delivery_sum) + " " + toDisplayString$1(unref(coreStorage).params.currency), 1)
                ])
              ], 10, _hoisted_3$9);
            }), 128)) : unref(searchStorage).loading ? (openBlock(), createElementBlock("div", _hoisted_6$2, _hoisted_8$2)) : (openBlock(), createElementBlock("div", _hoisted_9$2, toDisplayString$1(unref(t)("priceError")), 1))
          ], 512)
        ], 64)) : createCommentVNode("", true)
      ]);
    };
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        "priceError": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["There was a problem during cost calculation"]);
        },
        "title": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Select tariff"]);
        },
        "days": (ctx) => {
          const { normalize: _normalize, plural: _plural } = ctx;
          return _plural([_normalize(["days"]), _normalize(["day"]), _normalize(["days"])]);
        },
        "select": (ctx) => {
          const { normalize: _normalize } = ctx;
      ...
      "rus": {
        "priceError": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Не могу посчитать стоимость"]);
        },
        "title": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Выберите тариф"]);
        },
        "days": (ctx) => {
          const { normalize: _normalize, plural: _plural } = ctx;
          return _plural([_normalize(["дней"]), _normalize(["день"]), _normalize(["дня"]), _normalize(["дней"])]);
        },
        "select": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Выбрать"]);
        },
        "selected": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Выбран"]);
        }
      }
    }
  });
...
if (typeof block0$7 === "function")
  block0$7(_sfc_main$e);
const TariffInfo = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-bef4e663"]]);
const _hoisted_1$c = { class: "cdek-qujp2c" };
const _hoisted_2$a = { class: "cdek-1smek3" };
const _hoisted_3$8 = { class: "cdek-1txjjp" };
const _hoisted_4$7 = {
  key: 1,
  class: "cdek-u1m6pu"
};
...
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const coreStorage = core();
    const { t } = useI18n();
    const canShowTariffs = computed(() => {
      var _a, _b, _c, _d;
      if (mapStorage.fixedParams[YandexGeocoderKind.COUNTRY] !== null && mapStorage.fixedParams[YandexGeocoderKind.COUNTRY] !== ((_b = (_a = mapStorage.pointInfo) == null ? void 0 : _a.country_code) == null ? void 0 : _b.toLowerCase())) {
        return false;
      }
      if (mapStorage.fixedParams[YandexGeocoderKind.LOCALITY] !== null && (((_c = mapStorage.pointInfo) == null ? void 0 : _c.components) || []).filter((c) => c.kind === YandexGeocoderKind.LOCALITY).length < 1) {
        return false;
      }
      return !(mapStorage.fixedParams[YandexGeocoderKind.PROVINCE] !== null && (((_d = mapStorage.pointInfo) == null ? void 0 : _d.components) || []).filter((c) => c.kind === YandexGeocoderKind.PROVINCE).length < 1);
    });
    return (_ctx, _cache) => {
      var _a, _b, _c;
      return openBlock(), createElementBlock("div", {
        class: normalizeClass([{
          "cdek-i5n42d": !unref(coreStorage).openedPopups[unref(Popup).INFO] || unref(coreStorage).mode !== unref(DeliveryMode).DOOR || !unref(mapStorage).pointInfo
        }, "cdek-dorbss"])
      }, [
        createBaseVNode("div", _hoisted_1$c, [
          createBaseVNode("a", {
            class: "cdek-98j0ei",
            onClick: _cache[0] || (_cache[0] = ($event) => unref(coreStorage).togglePopup(unref(Popup).INFO))
          }),
          createBaseVNode("div", _hoisted_2$a, toDisplayString$1(unref(t)("title")), 1),
          createBaseVNode("div", _hoisted_3$8, toDisplayString$1((_a = unref(mapStorage).pointInfo) == null ? void 0 : _a.formatted), 1)
        ]),
        (((_b = unref(mapStorage).pointInfo) == null ? void 0 : _b.precision) === unref(YandexGeocoderPrecision).EXACT || ((_c = unref(mapStorage).pointInfo) == null ? void 0 : _c.precision) === unref(YandexGeocoderPrecision).NUMBER) && canShowTariffs.value ? (openBlock(), createBlock(TariffInfo, {
          key: 0,
          tariffs: unref(coreStorage).tariffs.door,
          class: "cdek-5mdqxp"
        }, null, 8, ["tariffs"])) : !canShowTariffs.value ? (openBlock(), createElementBlock("div", _hoisted_4$7, toDisplayString$1(unref(t)("forbidden")), 1)) : (openBlock(), createElementBlock("div", _hoisted_5$2, toDisplayString$1(unref(t)("needExactAddress")), 1))
      ], 2);
    };
  }
});
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        "title": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Delivery address"]);
        },
        "needExactAddress": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Please, select exact address"]);
        },
        "forbidden": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Delivery to that address is unavailable"]);
        }
      },
      "rus": {
        "title": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Адрес доставки"]);
        },
        "needExactAddress": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Выберите адрес точнее"]);
        },
        "forbidden": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Доставка в выбранный адрес недоступна"]);
        }
      }
    }
  });
...
const DoorExtendedInfo = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-99c1781e"]]);
const _hoisted_1$b = { class: "cdek-qujp2c" };
const _hoisted_2$9 = { class: "cdek-1smek3" };
const _hoisted_3$7 = { class: "cdek-fsvu2f" };
const _hoisted_4$6 = { class: "cdek-2ew9g8" };
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        class: normalizeClass([{
          "cdek-i5n42d": !unref(coreStorage).openedPopups[unref(Popup).INFO] || unref(coreStorage).mode !== unref(DeliveryMode).OFFICE
        }, "cdek-dorbss"])
      }, [
        createBaseVNode("div", _hoisted_1$b, [
          ...
          createBaseVNode("div", _hoisted_2$9, toDisplayString$1(unref(t)("title")) + " - " + toDisplayString$1((_a = unref(mapStorage).exactOffice) == null ? void 0 : _a.code), 1),
          createBaseVNode("div", _hoisted_3$7, toDisplayString$1((_b = unref(mapStorage).exactOffice) == null ? void 0 : _b.city) + ", " + toDisplayString$1((_c = unref(mapStorage).exactOffice) == null ? void 0 : _c.address), 1),
          createBaseVNode("div", _hoisted_4$6, [
            (openBlock(true), createElementBlock(Fragment, null, renderList((_e = (_d = unref(mapStorage).exactOffice) == null ? void 0 : _d.work_time) == null ? void 0 : _e.split(", "), (time, index) => {
              return openBlock(), createElementBlock("div", { key: index }, toDisplayString$1(time), 1);
            }), 128))
          ])
        ]),
        createVNode(TariffInfo, {
          tariffs: ((_f = unref(mapStorage).exactOffice) == null ? void 0 : _f.type) === unref(OfficeType).OFFICE ? unref(coreStorage).tariffs.office : unref(coreStorage).tariffs.pickup,
          class: "cdek-5mdqxp"
        }, null, 8, ["tariffs"])
      ], 2);
    };
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        ...
        "address": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Office address"]);
        },
        "workingTime": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Office working time"]);
        },
        "code": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Office code"]);
        }
      },
      "rus": {
        "title": (ctx) => {
        ...
        "address": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Адрес пункта выдачи заказов"]);
        },
        "workingTime": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Время работы"]);
        },
        "code": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Код ПВЗ"]);
        }
      }
    }
  });
...
const OfficeExtendedInfo = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-12c08071"]]);
const _withScopeId$4 = (n) => (pushScopeId("data-v-7ce10f2a"), n = n(), popScopeId(), n);
const _hoisted_1$a = {
  key: 0,
  class: "cdek-4zstr5"
};
...
const _hoisted_3$6 = ["placeholder", "title", "value"];
...
const _hoisted_9$1 = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ createBaseVNode("span", { class: "cdek-p9a13q" }, null, -1));
const _hoisted_10$1 = {
  key: 1,
  class: "cdek-7eeyz5"
};
const _hoisted_11$1 = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ createBaseVNode("span", { class: "cdek-6ncb86" }, null, -1));
const _hoisted_12$1 = ["onClick"];
const _hoisted_13$1 = { class: "cdek-7eeyz5" };
const _hoisted_14$1 = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ createBaseVNode("span", { class: "cdek-s1qo85" }, null, -1));
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(
      () => nextTick(() => {
        if (coreStorage.debug)
          console.debug("[CDEK] Initializing Search Prefect Scrollbar");
        new PerfectScrollbar(scrollableSearch.value);
      })
    );
    const searchInput = ref();
    const openSearchField = () => {
      searchStorage.$patch({ showSearchField: true });
      searchInput.value.focus();
    };
    const clearSearch = () => {
      searchStorage.$patch({ value: "" });
      searchStorage.$patch({ showSearchField: false });
    };
    const changeLocation = (location) => {
      clearSearch();
      mapStorage.$patch({ location });
    };
    const selectSearchPoint = (point) => {
      let zoom = YandexMapZoomVariants.GENERAL;
      if (coreStorage.params.hideDeliveryOptions[DeliveryMode.DOOR]) {
        if ([YandexGeocoderKind.ENTRANCE, YandexGeocoderKind.HOUSE, YandexGeocoderKind.STREET].indexOf(
          point.kind
        ) !== -1) {
      ...
      if (point.kind === YandexGeocoderKind.ENTRANCE || (point.kind === YandexGeocoderKind.HOUSE || point.precision === YandexGeocoderPrecision.EXACT || point.precision === YandexGeocoderPrecision.NUMBER) && !coreStorage.params.hideDeliveryOptions[DeliveryMode.DOOR]) {
        if (coreStorage.debug)
          console.debug("[CDEK] Switching delivery mode to door");
        coreStorage.$patch({ mode: DeliveryMode.DOOR, selectedTariff: null, selected: false });
        mapStorage.$patch({ pointInfo: point, exactPoint: point.position });
        coreStorage.togglePopup(Popup.INFO);
      }
    };
    const selectOffice = (point) => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", {
          class: normalizeClass([{ "cdek-gxcyiu": !unref(searchStorage).showSearchField }, "cdek-fptd2w"])
        }, [
          createBaseVNode("div", { onClick: openSearchField }, [
            unref(searchStorage).loading ? (openBlock(), createElementBlock("div", _hoisted_1$a)) : (openBlock(), createElementBlock("div", _hoisted_2$8))
          ]),
          createBaseVNode("div", {
            class: normalizeClass([{ "cdek-vfgr9z": !unref(searchStorage).showSearchField }, "cdek-d5xywz"])
          }, [
            createBaseVNode("input", {
              ref_key: "searchInput",
              ref: searchInput,
              placeholder: unref(t)(unref(coreStorage).mode === unref(DeliveryMode).OFFICE ? "title.office" : "title.door"),
              title: unref(t)(unref(coreStorage).mode === unref(DeliveryMode).OFFICE ? "title.office" : "title.door"),
              value: unref(searchStorage).value,
              class: "cdek-koxl8j",
              type: "text",
              onInput: _cache[0] || (_cache[0] = ($event) => unref(searchStorage).$patch({ value: $event.target.value }))
            }, null, 40, _hoisted_3$6)
          ], 2),
          createBaseVNode("div", {
            class: normalizeClass({
              "cdek-wa75fd": !unref(searchStorage).value,
              "cdek-vfgr9z": !unref(searchStorage).showSearchField,
              "cdek-iw4v9k": unref(searchStorage).showSearchField
            })
          }, [
            createBaseVNode("a", {
              title: unref(t)("clear"),
        ...
        createBaseVNode("div", {
          ...
          class: normalizeClass([{ "cdek-wa75fd": !unref(searchStorage).value }, "cdek-brn495"])
        }, [
          unref(searchStorage).loading ? (openBlock(), createElementBlock("div", _hoisted_5$1, toDisplayString$1(unref(t)("loading")), 1)) : unref(searchStorage).searchResults.length === 0 && (unref(coreStorage).params.hideDeliveryOptions[unref(DeliveryMode).OFFICE] || unref(mapStorage).searchedOffices.length === 0) ? (openBlock(), createElementBlock("div", _hoisted_6$1, toDisplayString$1(unref(t)("notFound")), 1)) : createCommentVNode("", true),
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(searchStorage).searchResults, (result, key) => {
            return openBlock(), createElementBlock("div", {
              key,
              class: "cdek-czqadm",
              onClick: ($event) => selectSearchPoint(result)
            }, [
              ([unref(YandexGeocoderKind).HOUSE, unref(YandexGeocoderKind).ENTRANCE].indexOf(result.kind) !== -1 || [unref(YandexGeocoderPrecision).EXACT, unref(YandexGeocoderPrecision).NUMBER].indexOf(result.precision) !== -1) && !unref(coreStorage).params.hideDeliveryOptions[unref(DeliveryMode).DOOR] ? (openBlock(), createElementBlock("span", _hoisted_8$1, [
                _hoisted_9$1,
                createBaseVNode("span", null, toDisplayString$1(unref(t)("door")), 1)
              ])) : (openBlock(), createElementBlock("span", _hoisted_10$1, [
                _hoisted_11$1,
                createBaseVNode("span", null, toDisplayString$1(unref(t)("region")), 1)
              ])),
              createBaseVNode("span", null, toDisplayString$1(result.formatted), 1)
            ], 8, _hoisted_7$1);
          }), 128)),
          !unref(coreStorage).params.hideDeliveryOptions[unref(DeliveryMode).OFFICE] ? (openBlock(true), createElementBlock(Fragment, { key: 2 }, renderList(unref(mapStorage).searchedOffices, (office) => {
            return openBlock(), createElementBlock("div", {
              key: office.code,
              class: "cdek-czqadm",
              onClick: ($event) => selectOffice(office)
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        ...
        "notFound": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Nothing found"]);
        },
        "loading": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Searching..."]);
        },
        "office": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["CDEK Office"]);
        },
        "region": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Region at the map"]);
        },
        "door": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Delivery address"]);
      ...
      "rus": {
        "title": {
          "door": (ctx) => {
            const { normalize: _normalize } = ctx;
            return _normalize(["Поиск адреса"]);
          },
          "office": (ctx) => {
            const { normalize: _normalize } = ctx;
        ...
        "clear": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Очистить"]);
        },
        "notFound": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Ничего не найдено"]);
        },
        "loading": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Выполняется поиск..."]);
        },
        "office": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Пункт СДЭК"]);
        },
        "region": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Область на карте"]);
        },
        "door": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Адрес доставки"]);
...
if (typeof block0$4 === "function")
  block0$4(_sfc_main$b);
const SearchComponent = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-7ce10f2a"]]);
const _withScopeId$3 = (n) => (pushScopeId("data-v-d38eb6c0"), n = n(), popScopeId(), n);
const _hoisted_1$9 = { class: "cdek-lb8o5c" };
const _hoisted_2$7 = ["title"];
const _hoisted_3$5 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ createBaseVNode("div", { class: "cdek-ow3fbb" }, null, -1));
const _hoisted_4$4 = [
  _hoisted_3$5
];
const _hoisted_5 = { class: "cdek-8lor9y" };
const _hoisted_6 = { class: "cdek-e0tqvh" };
const _hoisted_7 = { class: "cdek-d3rr5q" };
const _hoisted_8 = ["href"];
const _hoisted_9 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ createBaseVNode("div", { class: "cdek-emzuc1" }, null, -1));
const _hoisted_10 = [
  _hoisted_9
];
const _hoisted_11 = ["href"];
const _hoisted_12 = { class: "cdek-544iyh" };
const _hoisted_13 = ["href"];
const _hoisted_14 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ createBaseVNode("div", { class: "cdek-hf9h24" }, null, -1));
const _hoisted_15 = [
  _hoisted_14
];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$9, [
        createBaseVNode("a", {
          title: unref(t)("hint"),
          class: "cdek-5i3h1r",
          onClick: _cache[0] || (_cache[0] = ($event) => unref(coreStorage).togglePopup(unref(Popup).SUPPORT))
        }, _hoisted_4$4, 8, _hoisted_2$7),
        createBaseVNode("div", {
          class: normalizeClass([{ "cdek-wa75fd": !unref(coreStorage).openedPopups[unref(Popup).SUPPORT] }, "cdek-k5vey1"])
        }, [
          createBaseVNode("h1", _hoisted_5, toDisplayString$1(unref(t)("title")), 1),
          createBaseVNode("p", _hoisted_6, toDisplayString$1(unref(t)("text")), 1),
          createBaseVNode("div", _hoisted_7, [
            createBaseVNode("a", {
              href: `tel:${unref(config).promo.tel.data}`
            }, _hoisted_10, 8, _hoisted_8),
            createBaseVNode("a", {
              href: `tel:${unref(config).promo.tel.data}`
            }, toDisplayString$1(unref(config).promo.tel.title), 9, _hoisted_11)
          ]),
          createBaseVNode("div", _hoisted_12, [
            createBaseVNode("a", {
              href: `mailto:${unref(config).promo.mail}`
            }, _hoisted_15, 8, _hoisted_13),
            createBaseVNode("a", {
              href: `mailto:${unref(config).promo.mail}`
            }, toDisplayString$1(unref(config).promo.mail), 9, _hoisted_16)
          ])
        ], 2)
      ]);
    };
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        ...
        "title": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Support service"]);
        },
        "text": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["If you have any questions, you can ask them to our specialists"]);
        }
      },
      "rus": {
        "hint": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Поддержка"]);
        },
        "title": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Служба поддержки"]);
        },
        "text": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Если у вас есть вопросы, можете задать их нашим специалистам"]);
        }
      }
    }
  });
...
if (typeof block0$3 === "function")
  block0$3(_sfc_main$a);
const SupportComponent = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-d38eb6c0"]]);
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass([{ "cdek-lomc4o": props.disabled }, "cdek-i3d919 group"]),
        onClick: check
      }, [
        createBaseVNode("input", {
        ...
        createBaseVNode("span", {
          class: normalizeClass([{
            "cdek-0llzl4": !props.disabled,
            "cdek-69tgzw": props.disabled && props.modelValue,
            "cdek-vvik0h": props.disabled && !props.modelValue,
            "cdek-v057fo": !props.disabled && props.modelValue
          }, "cdek-4ra8ok"])
        }, [
          createBaseVNode("span", {
            class: normalizeClass([{ "cdek-wa75fd": !props.modelValue }, "cdek-yy00r7"])
          }, null, 2)
        ], 2),
        createBaseVNode("label", {
          class: normalizeClass([{ "cdek-6l3ax0": !props.disabled }, "cdek-b5qq25"])
        }, toDisplayString$1(props.label), 3)
      ], 2);
    };
  }
});
const CheckboxItem = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-9b3a9a10"]]);
const _hoisted_1$7 = { class: "cdek-v1zk6g" };
const _hoisted_2$6 = ["onClick"];
const _hoisted_3$4 = ["checked", "value", "onInput"];
const _hoisted_4$3 = { class: "cdek-b5qq25" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$7, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(props.items, (segment, index) => {
          return openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", {
              class: normalizeClass([{
                "cdek-lomc4o": props.disabled,
                "cdek-2ye2na": !props.disabled
              }, "cdek-6axdai group"])
            }, [
              createBaseVNode("span", {
                class: normalizeClass([{
                  "cdek-esea3r": index === selectedIndex.value,
                  "cdek-24amge": !props.disabled && index === selectedIndex.value,
                  "cdek-0llzl4": !props.disabled && index !== selectedIndex.value,
                  "cdek-vvik0h": props.disabled
                }, "cdek-uwxyud"])
              }, null, 2),
              createBaseVNode("label", _hoisted_4$3, toDisplayString$1(segment.label), 1)
            ], 2)
          ], 8, _hoisted_2$6);
        }), 128))
      ]);
...
const RadioButton = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-e1380078"]]);
const _hoisted_1$6 = { class: "cdek-lelauu" };
const _hoisted_2$5 = { class: "cdek-7bgzk4" };
const _hoisted_3$3 = { class: "cdek-iyw1ix" };
const _hoisted_4$2 = {
  key: 3,
  class: "cdek-qjta35"
};
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$6, [
        createBaseVNode("h1", _hoisted_2$5, toDisplayString$1(unref(t)("title")), 1),
        createBaseVNode("div", _hoisted_3$3, [
          !unref(searchStorage).hideFilters.have_cash ? (openBlock(), createBlock(CheckboxItem, {
            key: 0,
            disabled: unref(coreStorage).params.forceFilters.have_cash !== null,
            label: unref(t)("cash"),
            "model-value": unref(searchStorage).filters.have_cash,
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => unref(searchStorage).$patch({ filters: { ...unref(searchStorage).filters, have_cash: $event ? true : null } }))
          }, null, 8, ["disabled", "label", "model-value"])) : createCommentVNode("", true),
          !unref(searchStorage).hideFilters.have_cashless ? (openBlock(), createBlock(CheckboxItem, {
            key: 1,
            disabled: unref(coreStorage).params.forceFilters.have_cashless !== null,
            label: unref(t)("cashless"),
            "model-value": unref(searchStorage).filters.have_cashless,
            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => unref(searchStorage).$patch({ filters: { ...unref(searchStorage).filters, have_cashless: $event ? true : null } }))
          }, null, 8, ["disabled", "label", "model-value"])) : createCommentVNode("", true),
          !unref(searchStorage).hideFilters.is_dressing_room ? (openBlock(), createBlock(CheckboxItem, {
            key: 2,
            disabled: unref(coreStorage).params.forceFilters.is_dressing_room !== null,
            label: unref(t)("dress"),
            "model-value": unref(searchStorage).filters.is_dressing_room,
            "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => unref(searchStorage).$patch({
              filters: { ...unref(searchStorage).filters, is_dressing_room: $event ? true : null }
            }))
          }, null, 8, ["disabled", "label", "model-value"])) : createCommentVNode("", true),
          !unref(searchStorage).hideFilters.type ? (openBlock(), createElementBlock("div", _hoisted_4$2, [
            createVNode(RadioButton, {
              disabled: unref(coreStorage).params.forceFilters.type !== null,
              items: [
                { label: unref(t)("type.all"), value: unref(OfficeType).ALL },
                { label: unref(t)("type.pickup"), value: unref(OfficeType).PICKUP },
                { label: unref(t)("type.office"), value: unref(OfficeType).OFFICE }
              ],
              "model-value": unref(searchStorage).filters.type,
              "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => unref(searchStorage).$patch({ filters: { ...unref(searchStorage).filters, type: $event } }))
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        "hint": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Open filters"]);
        },
        "title": (ctx) => {
          const { normalize: _normalize } = ctx;
        ...
        "cashless": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Card payment"]);
        },
        "cash": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Cash payment"]);
        },
        "dress": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Have dressing room"]);
        },
        "type": {
          "all": (ctx) => {
            const { normalize: _normalize } = ctx;
          ...
          "office": (ctx) => {
            const { normalize: _normalize } = ctx;
            return _normalize(["Offices only"]);
          },
          "pickup": (ctx) => {
            const { normalize: _normalize } = ctx;
            return _normalize(["Pickup points only"]);
          }
        }
      },
      "rus": {
        "hint": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Открыть фильтры"]);
        },
        "title": (ctx) => {
          const { normalize: _normalize } = ctx;
        ...
        "cashless": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Оплата картой"]);
        },
        "cash": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Оплата наличными"]);
        },
        "dress": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Есть примерочная"]);
        },
        "type": {
          "all": (ctx) => {
            const { normalize: _normalize } = ctx;
          ...
          "office": (ctx) => {
            const { normalize: _normalize } = ctx;
            return _normalize(["Только ПВЗ"]);
          },
          "pickup": (ctx) => {
            const { normalize: _normalize } = ctx;
            return _normalize(["Только постаматы"]);
          }
        }
      }
    }
...
const FilterComponent = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-0fb54975"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        createBaseVNode("label", {
          class: normalizeClass([{
            "cdek-rulkfm": value.value,
            "cdek-fshz91": !value.value
          }, "cdek-58oolq"])
        }, [
          createBaseVNode("input", mergeProps({
            value: value.value,
            class: "cdek-mg7vjt peer"
          }, _ctx.$attrs, { onInput: setValue }), null, 16, _hoisted_1$5),
          _ctx.label ? (openBlock(), createElementBlock("div", {
            key: 0,
            class: normalizeClass([{
              "cdek-3nkngo": value.value
            }, "cdek-2dpwd5"])
...
const CdekInput = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-dbbd7325"]]);
const _withScopeId$2 = (n) => (pushScopeId("data-v-00421f0d"), n = n(), popScopeId(), n);
const _hoisted_1$4 = { class: "cdek-3f9gze" };
const _hoisted_2$4 = { class: "cdek-d0hmb8" };
const _hoisted_3$2 = { class: "cdek-ykpfwv" };
const _hoisted_4$1 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ createBaseVNode("div", { class: "cdek-tcpfkz" }, null, -1));
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  __name: "PostcodeRequestModal",
  setup(__props) {
    const postcode = ref("");
    const { t } = useI18n();
    const coreStorage = core();
    ...
    const save = () => {
      if (!postcode.value)
        return;
      mapStorage.$patch((state) => state.pointInfo.postal_code = postcode.value);
      coreStorage.$patch(() => {
      });
    };
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1$4, [
          createBaseVNode("div", _hoisted_2$4, [
            createBaseVNode("h4", _hoisted_3$2, toDisplayString$1(unref(t)("title")), 1),
            createVNode(CdekInput, {
            ...
            createVNode(CdekButton, {
              ...
              default: withCtx(() => [
                createTextVNode(toDisplayString$1(unref(t)("button")), 1)
              ]),
              _: 1
            }, 8, ["disabled"])
          ])
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "eng": {
        "title": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["It was not possible to determine the departure address index, please enter it manually"]);
        },
        "label": (ctx) => {
          const { normalize: _normalize } = ctx;
      ...
      "rus": {
        "title": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Не получилось определить индекс адреса отправления, введите его вручную"]);
        },
        "label": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Почтовый индекс"]);
        },
        "button": (ctx) => {
          const { normalize: _normalize } = ctx;
...
const PostcodeRequestModal = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-00421f0d"]]);
const _hoisted_1$3 = {
  key: 0,
  class: "cdek-4zstr5"
};
  ...
  setup(__props) {
    ...
    const captureLocation = () => {
      ...
      if (!Object.prototype.hasOwnProperty.call(window, "ymaps3")) {
        loading.value = false;
        console.error("[CDEK] ymaps3 unavailable when tried to geolocate");
      }
      ymaps3.geolocation.getPosition({
        enableHighAccuracy: true,
        maximumAge: 6e4
      }).then((result) => {
        if (coreStorage.debug) {
          console.debug("[CDEK] ymaps3 geocoded", result);
        }
        mapStorage.location.center = result.coords;
        mapStorage.location.zoom = YandexMapZoomVariants.STREET;
        mapStorage.geolocation = result.coords;
      }).catch((e) => {
        console.error("[CDEK] ymaps3 geolocate error", e);
      }).finally(() => {
        loading.value = false;
      });
    };
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        loading.value ? (openBlock(), createElementBlock("div", _hoisted_1$3)) : (openBlock(), createElementBlock("div", _hoisted_2$3))
      ]);
    };
  }
});
const GeolocationComponent = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-f4b02052"]]);
const _withScopeId$1 = (n) => (pushScopeId("data-v-474e79d5"), n = n(), popScopeId(), n);
const _hoisted_1$2 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("div", { class: "cdek-ae9hal" }, null, -1));
const _hoisted_2$2 = [
  _hoisted_1$2
];
const _hoisted_3$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("div", { class: "cdek-4le08f" }, null, -1));
const _hoisted_4 = [
  _hoisted_3$1
];
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  __name: "ZoomComponent",
  setup(__props) {
    const mapStorage = map();
    const coreStorage = core();
    const changeZoom = (value) => {
      if (coreStorage.debug) {
        console.debug("[CDEK] Changing zoom", mapStorage.location.zoom, value);
      }
      mapStorage.location.zoom += value;
    };
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", {
          class: "cdek-inz7xm",
          onClick: _cache[0] || (_cache[0] = ($event) => changeZoom(1))
        }, _hoisted_2$2),
        createBaseVNode("div", {
          class: "cdek-inz7xm",
          onClick: _cache[1] || (_cache[1] = ($event) => changeZoom(-1))
        }, _hoisted_4)
      ], 64);
    };
  }
});
const ZoomComponent = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-474e79d5"]]);
const _withScopeId = (n) => (pushScopeId("data-v-d3c70d35"), n = n(), popScopeId(), n);
const _hoisted_1$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "cdek-6gqbf8" }, null, -1));
const _hoisted_2$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "cdek-w9smev" }, null, -1));
const _hoisted_3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "cdek-k4y6mp" }, null, -1));
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const root2 = ref();
    watch(mapStorage.location, () => location.value = { ...mapStorage.location });
    const availableModels = computed(
      () => [
        {
          label: t(coreStorage.params.sender ? "from.office" : "to.office"),
          value: DeliveryMode.OFFICE
        },
        {
          label: t(coreStorage.params.sender ? "from.door" : "to.door"),
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        unref(coreStorage).uiLoadLocksCounter < 1 && !unref(coreStorage).params.hideDeliveryOptions[unref(DeliveryMode).OFFICE] && !unref(coreStorage).params.hideDeliveryOptions[unref(DeliveryMode).DOOR] ? (openBlock(), createBlock(SegmentedControl, {
          key: 0,
        ...
        createBaseVNode("div", {
          ...
          ref: root2,
          class: normalizeClass([{
            "opened-menu": unref(coreStorage).openedPopups[unref(Popup).MENU] || unref(coreStorage).openedPopups[unref(Popup).INFO] && (unref(mapStorage).pointInfo || unref(coreStorage).mode === unref(DeliveryMode).OFFICE)
          }, "cdek-qk4tbx"])
        }, [
          createVNode(unref(_sfc_main$k), {
            ...
            default: withCtx(() => [
              createVNode(unref(_sfc_main$j), {
                settings: {
                  onUpdate: unref(mapStorage).update,
                  onClick: unref(mapStorage).customClick
                }
              }, null, 8, ["settings"]),
              createVNode(unref(_sfc_main$h$1)),
              createVNode(unref(_sfc_main$i)),
              createVNode(unref(_sfc_main$a$1), { settings: { position: "bottom right", orientation: "vertical" } }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$9$1), null, {
                    default: withCtx(() => [
                      createVNode(ZoomComponent)
                    ]),
                    _: 1
                  }),
                  createVNode(unref(_sfc_main$9$1), null, {
                    default: withCtx(() => [
                      createVNode(GeolocationComponent)
                    ]),
                    _: 1
                  })
                ]),
              ...
              createVNode(unref(_sfc_main$a$1), { settings: { position: "top left", orientation: "horizontal" } }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$9$1), null, {
                    default: withCtx(() => [
                      createVNode(SearchComponent)
                    ]),
                    _: 1
                  }),
                  !unref(coreStorage).params.hideFilters.have_cashless || !unref(coreStorage).params.hideFilters.have_cash || !unref(coreStorage).params.hideFilters.is_dressing_room || !unref(coreStorage).params.hideFilters.type ? (openBlock(), createBlock(unref(_sfc_main$9$1), {
                    key: 0,
                    class: "cdek-rez3tg",
                    onClick: _cache[1] || (_cache[1] = ($event) => unref(coreStorage).togglePopup(unref(Popup).FILTERS))
                  }, {
                    default: withCtx(() => [
                      _hoisted_1$1
                    ]),
                  ...
                  unref(coreStorage).openedPopups[unref(Popup).FILTERS] ? (openBlock(), createBlock(unref(_sfc_main$9$1), {
                    key: 1,
                    class: "cdek-alrio7"
                  }, {
                    default: withCtx(() => [
                      createVNode(FilterComponent)
                    ]),
                    _: 1
                  })) : createCommentVNode("", true)
                ]),
              ...
              createVNode(unref(_sfc_main$a$1), { settings: { position: "bottom left", orientation: "vertical" } }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$9$1), { class: "cdek-alrio7" }, {
                    default: withCtx(() => [
                      createVNode(SupportComponent)
                    ]),
                    _: 1
                  })
                ]),
              ...
              unref(coreStorage).mode === unref(DeliveryMode).OFFICE ? (openBlock(), createBlock(unref(_sfc_main$a$1), {
                key: 0,
                settings: { position: "top right", orientation: "horizontal" }
              }, {
                default: withCtx(() => [
                  !unref(coreStorage).openedPopups[unref(Popup).MENU] ? (openBlock(), createBlock(unref(_sfc_main$9$1), {
                    key: 0,
                    class: "cdek-rez3tg",
                    onClick: _cache[2] || (_cache[2] = ($event) => unref(coreStorage).togglePopup(unref(Popup).MENU))
                  }, {
                    default: withCtx(() => [
                      _hoisted_2$1
                    ]),
              ...
              unref(coreStorage).mode === unref(DeliveryMode).OFFICE ? (openBlock(), createBlock(unref(_sfc_main$1$1), {
                key: 1,
                "grid-size": 64
              }, {
                cluster: withCtx(({ length }) => [
                  createBaseVNode("div", {
                    class: normalizeClass([{
                      "cdek-36s6q6": length < 10,
                      "cdek-2wsl17": length >= 10,
                      "cdek-oto7f8": length > 999 && length < 1e4,
                      "cdek-61or5d": length > 99 && length < 1e3,
                      "cdek-17yh8q": length < 100
                    }, "cdek-5zk4s3"])
                  }, toDisplayString$1(length), 3)
                ]),
                default: withCtx(() => [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(mapStorage).packageSuitedOffices, (office) => {
                    return openBlock(), createBlock(unref(_sfc_main$d$1), {
                      ...
                      default: withCtx(() => [
                        office.type === unref(OfficeType).OFFICE ? (openBlock(), createBlock(unref(OfficeIcon), {
                          key: 0,
                          class: "cdek-6pvvrh"
                        })) : (openBlock(), createBlock(unref(PickupIcon), {
                          key: 1,
                          class: "cdek-6pvvrh"
                        }))
                      ]),
              ...
              unref(mapStorage).exactPoint !== null && unref(coreStorage).mode === unref(DeliveryMode).DOOR ? (openBlock(), createBlock(unref(_sfc_main$d$1), {
                key: 2,
                settings: { coordinates: unref(mapStorage).exactPoint }
              }, {
                default: withCtx(() => [
                  createVNode(unref(DoorIcon), { class: "cdek-6pvvrh" })
                ]),
                _: 1
              }, 8, ["settings"])) : createCommentVNode("", true),
              unref(mapStorage).geolocation !== null ? (openBlock(), createBlock(unref(_sfc_main$d$1), {
                key: 3,
                settings: { coordinates: unref(mapStorage).geolocation }
              }, {
                default: withCtx(() => [
                  _hoisted_3
                ]),
          ...
          unref(coreStorage).mode === unref(DeliveryMode).OFFICE ? (openBlock(), createBlock(MenuComponent, { key: 0 })) : createCommentVNode("", true),
          createVNode(DoorExtendedInfo),
          createVNode(OfficeExtendedInfo),
          unref(coreStorage).mode === unref(DeliveryMode).DOOR && unref(coreStorage).params.requirePostcode && unref(mapStorage).pointInfo !== null && unref(mapStorage).pointInfo.postal_code === null && (unref(coreStorage).selected || unref(coreStorage).selectedTariff !== null) ? (openBlock(), createBlock(PostcodeRequestModal, { key: 1 })) : createCommentVNode("", true)
        ], 2)
      ], 64);
    };
  }
    ...
    "resource": {
      "eng": {
        "to": {
          "office": (ctx) => {
            const { normalize: _normalize } = ctx;
            return _normalize(["Deliver to office"]);
          },
          "door": (ctx) => {
            const { normalize: _normalize } = ctx;
            return _normalize(["Delivery to door"]);
          }
        },
        "from": {
          "office": (ctx) => {
            const { normalize: _normalize } = ctx;
            return _normalize(["Deliver from office"]);
          },
          "door": (ctx) => {
            const { normalize: _normalize } = ctx;
            return _normalize(["Delivery from door"]);
          }
        }
      },
      "rus": {
        "to": {
          "office": (ctx) => {
            const { normalize: _normalize } = ctx;
            return _normalize(["Доставить в пункт выдачи"]);
          },
          "door": (ctx) => {
            const { normalize: _normalize } = ctx;
            return _normalize(["Доставить до двери"]);
          }
        },
        "from": {
          "office": (ctx) => {
            const { normalize: _normalize } = ctx;
            return _normalize(["Доставить от пункта выдачи"]);
          },
          "door": (ctx) => {
            const { normalize: _normalize } = ctx;
            return _normalize(["Доставить от двери"]);
          }
        }
      }
    }
...
if (typeof block0 === "function")
  block0(_sfc_main$2);
const MapComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-d3c70d35"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const el = ref(null);
    const width = ref(800);
    useResizeObserver(el, (entries) => width.value = entries[0].contentRect.width);
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ref_key: "el",
        ref: el,
        class: normalizeClass([{ mobile: width.value < 555 }, "cdek-jipbqv"])
      }, [
        unref(coreStorage).uiLoadLocksCounter > 0 ? (openBlock(), createBlock(LoaderComponent, { key: 0 })) : createCommentVNode("", true),
        unref(mapStorage).mapLoadError.value === null ? (openBlock(), createBlock(MapComponent, { key: 1 })) : (openBlock(), createBlock(ErrorMessageComponent, { key: 2 }))
      ], 2);
    };
  }
});
const App = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-3945c500"]]);
const _hoisted_1 = {
  key: 0,
  class: "cdek-o13fdj"
};
const _hoisted_2 = { class: "cdek-tfy3yo" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "PopupWrapper",
  setup(__props) {
    const coreStorage = core();
    return (_ctx, _cache) => {
      return unref(coreStorage).params.popup ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
        unref(coreStorage).globalPopup ? (openBlock(), createElementBlock("div", _hoisted_1, [
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("a", {
              class: "cdek-it7gjf",
              onClick: _cache[0] || (_cache[0] = () => unref(coreStorage).closeWidget())
            }),
            createVNode(App, { class: "max-w-4xl h-[600px] w-[300px] sm:w-[500px] md:w-[600px] lg:w-[800px]" })
          ]),
          createBaseVNode("div", {
            class: "cdek-t4f5h0",
            onClick: _cache[1] || (_cache[1] = () => unref(coreStorage).closeWidget())
          })
        ])) : createCommentVNode("", true)
      ], 64)) : (openBlock(), createBlock(App, { key: 1 }));
    };
  }
});
...
const widgetSchema = create$3({
  ...
  // Legacy - showLogs
  requirePostcode: create$7().default(false),
  fixBounds: create$6().oneOf([YandexGeocoderKind.COUNTRY, YandexGeocoderKind.PROVINCE, YandexGeocoderKind.LOCALITY]).nullable().default(null),
  ...
  // Legacy - goods
  from: create(
    (val) => typeof val === "string" ? create$6().nullable().default(null) : create$3({
      code: create$5().nullable().default(null),
      postal_code: create$6().nullable().default(null),
      country_code: create$6().nullable().default(null),
      city: create$6().nullable().default(null),
      address: create$6().nullable().default(null)
    }).nullable().default(null)
  ),
  // Legacy - from
  ...
  tariffs: create$3({
    ...
    // Legacy - service.php
    office: create$2().default([481, 483, 185, 187, 232, 291, 295, 234, 136, 138, 15, 17, 10, 12, 5, 62, 63]),
    // Legacy - service.php
    pickup: create$2().default([361, 363, 366, 368, 376, 378, 497, 498, 485, 486])
  }),
...
class YandexApi extends AbstractApi {
  ...
  formatGeocodeResponse(result) {
    return {
      ...
      members: result.GeoObjectCollection.featureMember.map((el) => ({
        position: el.GeoObject.Point.pos.split(" ").map((e) => parseFloat(e)),
        bounds: {
          lower: el.GeoObject.boundedBy.Envelope.lowerCorner.split(" ").map((e) => parseFloat(e)),
          upper: el.GeoObject.boundedBy.Envelope.upperCorner.split(" ").map((e) => parseFloat(e))
        },
        name: el.GeoObject.name,
        kind: el.GeoObject.metaDataProperty.GeocoderMetaData.kind,
        precision: el.GeoObject.metaDataProperty.GeocoderMetaData.precision,
        formatted: el.GeoObject.metaDataProperty.GeocoderMetaData.Address.formatted,
        country_code: el.GeoObject.metaDataProperty.GeocoderMetaData.Address.country_code,
        postal_code: el.GeoObject.metaDataProperty.GeocoderMetaData.Address.postal_code || null,
        components: el.GeoObject.metaDataProperty.GeocoderMetaData.Address.Components.map((el2) => ({
          kind: el2.kind,
          name: el2.name
        }))
      }))
...
class Widget {
  constructor(input) {
    ...
    const el = window.document.getElementById(this.params.root);
    if (el === null) {
    ...
    this.app.use(pinia).use(i18n(this.params.lang)).use(
      createYmaps({
  ...
  async fixBounds() {
    if (this.params.fixBounds === null)
      return;
    const coreStorage = core();
    const mapStorage = map();
    const geoData = await this.yandexApi.geocodeCoordinates(mapStorage.location.center);
    if (coreStorage.debug) {
      console.debug("[CDEK] Geocoded members for bounds", geoData);
    }
    if (geoData.found < 1) {
      console.warn("[CDEK] Unable to geocode bounds");
      return;
    }
    const targetMember = geoData.members.filter((val) => val.kind === this.params.fixBounds);
    if (targetMember.length < 1) {
      console.warn("[CDEK] Unable to find member with kind", this.params.fixBounds);
      return;
    }
    if (coreStorage.debug) {
      console.debug("[CDEK] Fixing map to ", targetMember[0]);
    }
    mapStorage.fixedBounds = targetMember[0].bounds;
    mapStorage.fixedParams[YandexGeocoderKind.COUNTRY] = targetMember[0].country_code.toLowerCase();
    targetMember[0].components.forEach((component) => {
      switch (component.kind) {
        case YandexGeocoderKind.LOCALITY:
          mapStorage.fixedParams[YandexGeocoderKind.LOCALITY] = component.name.toLowerCase();
          break;
        case YandexGeocoderKind.PROVINCE:
          mapStorage.fixedParams[YandexGeocoderKind.PROVINCE] = component.name.toLowerCase();
          break;
      }
    });
  }
  async init() {
    ...
    coreStorage.$subscribe(async (mutation, state) => {
      ...
      if (state.mode === DeliveryMode.OFFICE) {
        ...
        target = {
          city: (_b = (_a = target.components.filter((el) => el.kind === YandexGeocoderKind.LOCALITY)) == null ? void 0 : _a[0]) == null ? void 0 : _b.name,
          ...target
        };
        if (target.postal_code === null && coreStorage.params.requirePostcode) {
          console.warn("[CDEK] Select button clicked, but door postcode is empty", target);
          return;
        }
      }
      if (coreStorage.debug) {
