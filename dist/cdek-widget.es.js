...
var define_import_meta_env_default = { VITE_EXSHIN_ROOT: "http://external-shops-integrator.dev2.k8s-local.cdek.ru", BASE_URL: "/", MODE: "production", DEV: false, PROD: true, SSR: false };
const config = {
  map: {
...
const _withScopeId = (n) => (pushScopeId("data-v-cac4724d"), n = n(), popScopeId(), n);
...
if (typeof block0 === "function")
  block0(_sfc_main$2);
const MapComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-cac4724d"]]);
      ...
      ({
        ...
        after(() => {
          ...
          if (store2.uiLoadLocksCounter > 0)
            return;
          if (store2.debug) {
            console.debug("[CDEK] Widget 3.9.7 has been loaded");
          }
