...
var define_import_meta_env_default = { VITE_TOKEN: "v4.local.2nHgW00bCuzaBHAvZymY5t48WnP3T9eikXhFFo_cquhNFl1Ffz-6jcYT93XfdGYbaPuQsI1GwWgutLBpZ9JpawV7y0NUpDPpfbnlKkeqApTL6n8gbio_y45XqfrIHk8oKaPF85fe4JgPkmuX0WUQ-PxlxzquWuAELNdMI4o3HGx5P4R4wClH023MlQIbWqypquwj6Rl8TX-I0nh_Y_rbbIFbqRJhkdDpRMAFk-EwSJsFS_te9MJgE9eG6O1KIAktGwVcWXpZdp3TixTb8EF-a2If0mBpUfB0ROkTQx8s_YIte3-6ALBOekOgbvm-ydMB_bOfP8yQbL7FXlyWEtrzcYeM8DYsIOjEUuRK-GpUOUqZwtmxke-R8vrVuKNXsrwPMT956AukJEUO3PAoDZL9HoXgwjGN-OJdNgRFqG5YNVleiPHg0ZVLF4FLFsske5cNWsL3TmzkRkMO8_OLe0N9p21EuVBKAEVNag.eyJlbmRwb2ludCI6Imh0dHBzOlwvXC9hcGkuZGV2Mi5jZGVrLnJ1In0", BASE_URL: "/", MODE: "production", DEV: false, PROD: true, SSR: false };
const config = {
  map: {
...
const app = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f993c0ac"]]);
    ...
    coreStorage.$onAction(({ name, store: store2, after }) => {
      ...
      after(() => {
        ...
        if (store2.uiLoadLocksCounter > 0)
          return;
        if (store2.debug) {
          console.debug("[CDEK] Widget 3.10.2 has been loaded");
        }
