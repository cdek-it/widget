...
* @license MIT
**/
const vue_runtime_esmBundler = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, Comment, EffectScope, Fragment, ReactiveEffect, Static, Text, callWithAsyncErrorHandling, callWithErrorHandling, camelize, capitalize: capitalize$1, cloneVNode, computed, createApp, createBlock, createCommentVNode, createElementBlock, createElementVNode: createBaseVNode, createRenderer, createStaticVNode, createTextVNode, createVNode, defineComponent, effectScope, getCurrentInstance, getCurrentScope, guardReactiveProps, h, handleError, hasInjectionContext, inject, isProxy, isReactive, isReadonly, isRef, isShallow, isVNode: isVNode$1, markRaw, mergeProps, nextTick, normalizeClass, normalizeStyle, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onMounted, onRenderTracked, onRenderTriggered, onScopeDispose, onServerPrefetch, onUnmounted, onUpdated, openBlock, popScopeId, provide, proxyRefs, pushScopeId, queuePostFlushCb, reactive, readonly, ref, renderList, renderSlot, setBlockTracking, shallowReactive, shallowRef, ssrContextKey, toDisplayString: toDisplayString$1, toHandlerKey, toRaw, toRef, toRefs, unref, useSSRContext, version, watch, withCtx }, Symbol.toStringTag, { value: "Module" }));
var isVue2$1 = false;
/*!
* pinia v2.1.7
...
var define_import_meta_env_default = { VITE_TOKEN: "v4.local.PM4_YT4r2YJvAgOvG6XO6l6_6KoVbnV-1qPNNnMW7UkIsWtV5WVUielVbzbxi5v55D1FbBKcHQMshmDoXHYJ8xHBeQakpTF1Wx36SocTce00H6SZH9PXCk1JnoTFoxGDEEVYheLs0Bp7VQ-EQteFYNiT1Jt3Vn0FrDNrFF9z2fzBR4vE9g5bfslvzDVlEt7Y42H2yTPHd-AhiNcur-hnzCUNIetATn5PQawTJHRqtVLa2xzGYtsL-jVkCbvHxz7gWDwD9EM4C5Yvyu4toMAh4hhUL1MD43ITgSrfGrfXaeMI-W5_jIMaD-uagLTHUWR-0fB_WEKQt_-XmOfSuwQcVSThfQNtyPx7WDCkQamjSrI9IwBEZYdsFGcHn_vO1Y5OG8n2sEYZ34m2Yz9cY7wzgeLmxTbxIrKpDROxWgtVC_H2g4ATsA7VLJhmf32OtC6a1MVcM9EJikT-wUDt-QzqGU2SpgsgzCou3SJPuvCDoSCRrcvpa0UGdAdKcx9a3mXpWFnS3JGXAnM.eyJlbmRwb2ludCI6Imh0dHBzOlwvXC9hcGktc2FuZGJveC5jZGVrLnJ1XC9jbXMifQ", BASE_URL: "/", MODE: "production", DEV: false, PROD: true, SSR: false };
const config = {
  map: {
...
const _hoisted_2$h = /* @__PURE__ */ createStaticVNode('<defs data-v-33f972d8><radialGradient id="paint0_angular_102_1932" cx="24" cy="0" r="48" gradientUnits="userSpaceOnUse" data-v-33f972d8><stop offset="0.177083" stop-color="currentColor" stop-opacity="0.5" data-v-33f972d8></stop><stop offset="1" stop-color="currentColor" stop-opacity="0" data-v-33f972d8></stop></radialGradient></defs><circle cx="24" cy="24" r="23" stroke="currentColor" stroke-opacity="0.1" stroke-width="2" data-v-33f972d8></circle><path fill-rule="evenodd" clip-rule="evenodd" d="M24 0C10.7452 0 0 10.7452 0 24C0 37.2548 10.7452 48 24 48V46C11.8497 46 2 36.1503 2 24C2 11.8497 11.8497 2 24 2V0Z" fill="url(#paint0_angular_102_1932)" data-v-33f972d8></path><circle cx="24" cy="1" r="1" fill="currentColor" data-v-33f972d8></circle><animateTransform from="0 0 0" to="360 0 0" attributeName="transform" type="rotate" repeatCount="indefinite" dur="1300ms" data-v-33f972d8></animateTransform>', 5);
const _hoisted_7$4 = [
  _hoisted_2$h
];
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1$k, _hoisted_7$4);
}
const CdekSpinner = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render], ["__scopeId", "data-v-33f972d8"]]);
const _hoisted_1$j = { class: "cdek-hlhf5b" };
...
const LoaderComponent = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["__scopeId", "data-v-de740b2c"]]);
/*!
* shared v9.11.0
...
const _hoisted_1$i = { class: "cdek-6dauvy" };
...
const ErrorMessageComponent = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-47d6a614"]]);
var VueYandexMaps;
((VueYandexMaps2) => {
...
async function setFragment() {
  ...
  fragment = (await Promise.resolve().then(() => vue_runtime_esmBundler)).Fragment;
}
...
async function getLocationFromBounds({
  ...
  let zoom = findZoom(projection, bounds, applyMarginToCoords(size2, margin), isSnap, zoomRange);
...
function render$2(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1$h, [..._hoisted_8$4]);
}
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(props.items, (segment, index) => {
          return openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", _hoisted_4$a, [
              createBaseVNode("label", _hoisted_5$6, toDisplayString$1(segment.label), 1)
            ])
          ], 10, _hoisted_2$c);
        }), 128))
      ]);
...
const SegmentedControl = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-e8e63356"]]);
/*!
...
const _withScopeId$6 = (n) => (pushScopeId("data-v-15a51cb5"), n = n(), popScopeId(), n);
const _hoisted_1$d = { class: "cdek-7b210z" };
...
const _hoisted_5$5 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("span", { class: "cdek-q4k1hq" }, null, -1));
...
const _sfc_main$g = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    watchDebounced(
      mapStorage.bounds,
      () => {
        if (!scrollableMenu.value) {
          return;
        }
        if (coreStorage.debug)
          console.debug("[CDEK] Resetting menu scroll");
        scrollableMenu.value.scroll(0, 0);
      },
      { debounce: 300 }
    );
...
const MenuComponent = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-15a51cb5"]]);
...
const CdekButton = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-e4dfb417"]]);
const _withScopeId$5 = (n) => (pushScopeId("data-v-cbf16477"), n = n(), popScopeId(), n);
const _hoisted_1$c = { key: 0 };
const _hoisted_2$a = { class: "cdek-paz0c8" };
const _hoisted_3$9 = { class: "cdek-elq2oy" };
const _hoisted_4$8 = ["onClick"];
const _hoisted_5$4 = {
  key: 0,
  class: "cdek-0os0h6"
};
const _hoisted_6$2 = { class: "cdek-psbor4" };
const _hoisted_7$2 = {
  key: 1,
  class: "cdek-fjsxo0"
};
const _hoisted_8$2 = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ createBaseVNode("div", { class: "cdek-zghbpn" }, null, -1));
const _hoisted_9$2 = [
  _hoisted_8$2
];
const _hoisted_10$2 = {
          ...
          createBaseVNode("div", _hoisted_3$9, [
            _ctx.tariffs.length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(_ctx.tariffs, (tariff) => {
              return openBlock(), createElementBlock("div", {
                ...
                unref(coreStorage).selectedTariff !== null && unref(coreStorage).selectedTariff.tariff_code === tariff.tariff_code ? (openBlock(), createElementBlock("i", _hoisted_5$4)) : createCommentVNode("", true),
            ...
            }), 128)) : unref(searchStorage).loading ? (openBlock(), createElementBlock("div", _hoisted_7$2, _hoisted_9$2)) : (openBlock(), createElementBlock("div", _hoisted_10$2, toDisplayString$1(unref(t)("priceError")), 1))
          ])
        ], 64)) : createCommentVNode("", true)
      ]);
    };
...
const TariffInfo = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-cbf16477"]]);
const _hoisted_1$b = { class: "cdek-kf9rpr" };
const _hoisted_2$9 = { class: "cdek-1smek3" };
const _hoisted_3$8 = { class: "cdek-lipuny" };
const _hoisted_4$7 = {
  key: 1,
  class: "cdek-u1m6pu"
};
...
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(
      () => nextTick(() => {
        if (coreStorage.debug)
          console.debug("[CDEK] Initializing Office Prefect Scrollbar");
        try {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          }, null, 8, ["tariffs"])) : !canShowTariffs.value ? (openBlock(), createElementBlock("div", _hoisted_4$7, toDisplayString$1(unref(t)("forbidden")), 1)) : (openBlock(), createElementBlock("div", _hoisted_5$3, toDisplayString$1(unref(t)("needExactAddress")), 1))
        ], 512)
      ], 2);
    };
  }
...
const DoorExtendedInfo = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-44fde694"]]);
const _hoisted_1$a = { class: "cdek-kf9rpr" };
const _hoisted_2$8 = { class: "cdek-1smek3" };
const _hoisted_3$7 = { class: "cdek-qmwuzg" };
const _hoisted_4$6 = { class: "cdek-fsvu2f" };
const _hoisted_5$2 = { class: "cdek-2ew9g8" };
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_3$7, [
            createBaseVNode("div", _hoisted_4$6, toDisplayString$1((_c = unref(mapStorage).exactOffice) == null ? void 0 : _c.city) + ", " + toDisplayString$1((_d = unref(mapStorage).exactOffice) == null ? void 0 : _d.address), 1),
...
const OfficeExtendedInfo = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-7641f28d"]]);
const _withScopeId$4 = (n) => (pushScopeId("data-v-e47c72c1"), n = n(), popScopeId(), n);
const _hoisted_1$9 = {
  key: 0,
  class: "cdek-4zstr5"
};
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", {
          ...
          createBaseVNode("div", { onClick: openSearchField }, [
            unref(searchStorage).loading ? (openBlock(), createElementBlock("div", _hoisted_1$9)) : (openBlock(), createElementBlock("div", _hoisted_2$7))
          ]),
          createBaseVNode("div", {
...
const SearchComponent = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-e47c72c1"]]);
const _withScopeId$3 = (n) => (pushScopeId("data-v-74e1b013"), n = n(), popScopeId(), n);
const _hoisted_1$8 = { class: "cdek-lb8o5c" };
...
const SupportComponent = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-74e1b013"]]);
...
const CheckboxItem = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-bc18ce43"]]);
const _hoisted_1$6 = { class: "cdek-v1zk6g" };
...
const RadioButton = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-fef968aa"]]);
const _hoisted_1$5 = { class: "cdek-lelauu" };
...
const FilterComponent = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-10b80710"]]);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        createBaseVNode("label", {
          ...
          }, _ctx.$attrs, { onInput: setValue }), null, 16, _hoisted_1$4),
...
const CdekInput = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-7ae3a2c9"]]);
const _withScopeId$2 = (n) => (pushScopeId("data-v-04136c94"), n = n(), popScopeId(), n);
const _hoisted_1$3 = { class: "cdek-3f9gze" };
...
const PostcodeRequestModal = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-04136c94"]]);
const _hoisted_1$2 = {
  key: 0,
  class: "cdek-4zstr5"
};
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        loading.value ? (openBlock(), createElementBlock("div", _hoisted_1$2)) : (openBlock(), createElementBlock("div", _hoisted_2$2))
      ]);
    };
  }
});
const GeolocationComponent = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-9273815d"]]);
const _withScopeId$1 = (n) => (pushScopeId("data-v-768c28b7"), n = n(), popScopeId(), n);
const _hoisted_1$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("div", { class: "cdek-ae9hal" }, null, -1));
const _hoisted_2$1 = [
  _hoisted_1$1
];
...
const ZoomComponent = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-768c28b7"]]);
const _withScopeId = (n) => (pushScopeId("data-v-75170e2d"), n = n(), popScopeId(), n);
const _hoisted_1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "cdek-lis35q" }, null, -1));
const _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "cdek-xe4g8d" }, null, -1));
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    watchOnce(map$1, () => {
      var _a, _b;
      mapStorage.bounds.left = (_a = map$1.value) == null ? void 0 : _a.bounds[0];
      mapStorage.bounds.right = (_b = map$1.value) == null ? void 0 : _b.bounds[1];
    });
    const showControl = computed(() => coreStorage.uiLoadLocksCounter < 1 && !coreStorage.params.hideDeliveryOptions[DeliveryMode.OFFICE] && !coreStorage.params.hideDeliveryOptions[DeliveryMode.DOOR]);
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        showControl.value ? (openBlock(), createBlock(SegmentedControl, {
          key: 0,
        ...
        createBaseVNode("div", {
          ...
          class: normalizeClass([{
            ...
            "cdek-r4yrgz": showControl.value,
            "cdek-82q8nr": !showControl.value
          }, "cdek-32nljf"])
        }, [
          createVNode(unref(_sfc_main$o), {
            modelValue: map$1.value,
            "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => map$1.value = $event),
            ...
            default: withCtx(() => [
              ...
              createVNode(unref(_sfc_main$d$1), { settings: { position: "top left", orientation: "horizontal" } }, {
                default: withCtx(() => [
                  ...
                  unref(coreStorage).openedPopups[unref(Popup).FILTERS] ? (openBlock(), createBlock(unref(_sfc_main$c$1), { key: 1 }, {
                    default: withCtx(() => [
                      createVNode(FilterComponent, { class: "cdek-alrio7" })
                    ]),
                    _: 1
                  })) : createCommentVNode("", true)
                ]),
              ...
              createVNode(unref(_sfc_main$d$1), { settings: { position: "bottom left", orientation: "vertical" } }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$c$1), null, {
                    default: withCtx(() => [
                      createVNode(SupportComponent, { class: "cdek-alrio7" })
                    ]),
                    _: 1
                  })
                ]),
              ...
              unref(mapStorage).exactPoint !== null && unref(coreStorage).mode === unref(DeliveryMode).DOOR ? (openBlock(), createBlock(unref(_sfc_main$g$1), {
                key: 2,
                settings: { coordinates: toRaw(unref(mapStorage).exactPoint) }
              }, {
                default: withCtx(() => [
              ...
              unref(mapStorage).geolocation !== null ? (openBlock(), createBlock(unref(_sfc_main$g$1), {
                key: 3,
                settings: { coordinates: toRaw(unref(mapStorage).geolocation) }
              }, {
                default: withCtx(() => [
                  _hoisted_3
                ]),
...
if (typeof block0 === "function")
  block0(_sfc_main$2);
const MapComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-75170e2d"]]);
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-4e5f56c7"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useResizeObserver(el, (entries) => height.value = entries[0].contentRect.height);
    return (_ctx, _cache) => {
      return unref(coreStorage).params.popup ? (openBlock(), createElementBlock("div", {
        key: 0,
        ref_key: "el",
        ref: el,
        class: normalizeClass([{ "cdek-wa75fd": !unref(coreStorage).globalPopup }, "cdek-o13fdj"])
      }, [
        createBaseVNode("div", {
          class: normalizeClass([{
            ...
            "cdek-30aqw6": height.value <= 600,
            "cdek-iz2c54": height.value > 660
          }, "cdek-1rkrs0"])
        }, [
          createBaseVNode("a", {
            class: "cdek-pw1flc",
            onClick: _cache[0] || (_cache[0] = () => unref(coreStorage).globalPopup = false)
          }),
          createVNode(App, {
            class: normalizeClass([{
              "cdek-l06zxo": height.value <= 600,
              "h-[600px]": height.value > 600
            }, "cdek-c66dnq"])
          }, null, 8, ["class"])
        ], 2),
        createBaseVNode("div", {
          class: "cdek-t4f5h0",
          onClick: _cache[1] || (_cache[1] = () => unref(coreStorage).globalPopup = false)
        })
      ], 2)) : (openBlock(), createBlock(App, { key: 1 }));
    };
  }
});
const app = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-540d2d0b"]]);
...
class YandexApi extends AbstractApi {
  ...
  async geocodeString(input) {
    ...
    return await axios.get(this.geocodeSrc, {
      params: {
        geocode: input,
        format: "json"
      },
...
class Widget {
  constructor(input) {
    ...
    if (!(window.self instanceof Window)) {
      throw "[CDEK] window.self should be instance of WindowProxy for proper work";
    }
  ...
  async updateLocation(location, zoom = YandexMapZoomVariants.GENERAL) {
    const coreStore = core();
    const mapStore = map();
    if (coreStore.debug) {
  ...
  selectOffice(code2) {
    const coreStorage = core();
    const mapStorage = map();
    const exactOffice = mapStorage.offices.filter((office) => office.code === code2);
    if (exactOffice.length > 0) {
      if (coreStorage.debug) {
        console.debug("[CDEK] Selected predefined office", toRaw(exactOffice[0]));
      }
      mapStorage.$patch({
        exactOffice: exactOffice[0],
        location: {
          ...mapStorage.location,
          center: exactOffice[0].location,
          zoom: 17
        }
      });
  ...
  async init() {
    ...
    coreStorage.$onAction(({ name, store: store2, after }) => {
      if (name !== "unlockUi")
        return;
      after(() => {
        var _a;
        if (store2.uiLoadLocksCounter > 0)
          return;
        if (store2.debug) {
          console.debug("[CDEK] Widget 3.10.3 has been loaded");
        }
