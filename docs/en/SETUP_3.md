...
| from.country_code             | string           | No value                         | Sender's country code in ISO_3166-1_alpha-2 format                                                                                                                                                                                                                                                            |
| from.city                     | string           | No value                         | Name of the sender's locality                                                                                                                                                                                                                                                                                 |
| from.postal_code              | integer          | No value                         | Postal code of the sender's locality                                                                                                                                                                                                                                                                          |
| from.code                     | integer          | No value                         | CDEK locality code                                                                                                                                                                                                                                                                                            |
| from.address                  | string           | No value                         | Address from where courier shipment will take place in the locality                                                                                                                                                                                                                                           |
...
| fixBounds                     | string           | `null`                           | The type of limitation of the display boundaries of the offices, can take values `'country'`, `'locality'`, `'province'`                                                                                                                                                                                      |
