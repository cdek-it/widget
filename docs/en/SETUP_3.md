...
| defaultLocation              | array\|string    | No value                         | Address string or array [latitude, longitude] of the point that will be displayed on the map when the widget is opened                                                                                                                                                                                        |
...
Where `address` is filled in when selecting delivery to the address, and `code` is the code of the selected pickup
