<div class="CDEK-widget" id="#WID#cdek_widget_cnt">
	<div class="CDEK-widget__preloader" id="#PRELOADER#">
		<div class="CDEK-widget__preloader-truck" >
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 440.34302 315.71001">
			  <g>
				<path class="path1" d="M416.43,188.455q-1.014-1.314-1.95-2.542c-7.762-10.228-14.037-21.74-19.573-31.897-5.428-9.959-10.555-19.366-16.153-25.871-12.489-14.513-24.24-21.567-35.925-21.567H285.128c-0.055.001-5.567,0.068-12.201,0.068h-9.409a14.72864,14.72864,0,0,0-14.262,11.104l-0.078.305V245.456l0.014,0.262a4.86644,4.86644,0,0,1-1.289,3.472c-1.587,1.734-4.634,2.65-8.812,2.65H14.345C6.435,251.839,0,257.893,0,265.334v46.388c0,7.441,6.435,13.495,14.345,13.495h49.36a57.8909,57.8909,0,0,0,115.335,0h82.61a57.89089,57.89089,0,0,0,115.335,0H414.53a25.8416,25.8416,0,0,0,25.813-25.811v-44.29C440.344,219.47,425.953,200.805,416.43,188.455ZM340.907,320.132a21.5865,21.5865,0,1,1-21.59-21.584A21.61074,21.61074,0,0,1,340.907,320.132ZM390.551,207.76c-0.451.745-1.739,1.066-3.695,0.941l-99.197-.005V127.782h42.886c11.539,0,19.716,5.023,28.224,17.337,5.658,8.19,20.639,33.977,21.403,35.293,0.532,1.027,1.079,2.071,1.631,3.125C386.125,191.798,392.658,204.279,390.551,207.76ZM121.372,298.548a21.58351,21.58351,0,1,1-21.583,21.584A21.6116,21.6116,0,0,1,121.372,298.548Z" transform="translate(0 -62.31697)"/>
				<path class="path2" d="M30.234,231.317h68a12.51354,12.51354,0,0,0,12.5-12.5v-50a12.51354,12.51354,0,0,0-12.5-12.5h-68a12.51354,12.51354,0,0,0-12.5,12.5v50A12.51418,12.51418,0,0,0,30.234,231.317Z" transform="translate(0 -62.31697)"/>
				<path class="path3" d="M143.234,231.317h68a12.51354,12.51354,0,0,0,12.5-12.5v-50a12.51354,12.51354,0,0,0-12.5-12.5h-68a12.51354,12.51354,0,0,0-12.5,12.5v50A12.51418,12.51418,0,0,0,143.234,231.317Z" transform="translate(0 -62.31697)"/>
				<path class="path4" d="M30.234,137.317h68a12.51354,12.51354,0,0,0,12.5-12.5v-50a12.51355,12.51355,0,0,0-12.5-12.5h-68a12.51355,12.51355,0,0,0-12.5,12.5v50A12.51418,12.51418,0,0,0,30.234,137.317Z" transform="translate(0 -62.31697)"/>
				<path class="path5" d="M143.234,137.317h68a12.51354,12.51354,0,0,0,12.5-12.5v-50a12.51354,12.51354,0,0,0-12.5-12.5h-68a12.51354,12.51354,0,0,0-12.5,12.5v50A12.51418,12.51418,0,0,0,143.234,137.317Z" transform="translate(0 -62.31697)"/>
			  </g>
			</svg>
	...
	<div id="#MAP#" class="CDEK-widget__map"></div>
	<div class="CDEK-widget__search CDEK-widget__inaccessible">
		<div class="CDEK-widget__search-box">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 51.63557 50.41538">
			  <path class="path" d="M51.353,0.914A0.99853,0.99853,0,0,0,50.218.701L0.583,23.481a1,1,0,0,0,.252,1.895l22.263,3.731,2.545,21.038a1.00164,1.00164,0,0,0,.824.865,0.97388,0.97388,0,0,0,.169.015,0.999,0.999,0,0,0,.896-0.556l24-48.415A0.99978,0.99978,0,0,0,51.353.914ZM27.226,46.582L24.994,28.125a1.00155,1.00155,0,0,0-.828-0.866L4.374,23.941,48.485,3.697Z" transform="translate(-0.0002 -0.6096)"/>
			</svg>
			<input type="text" name="town" value="#CITY#" placeholder="#CITYSEARCH#" id="#WID#cdek_search_input">
		...
		<div class="CDEK-widget__delivery-type">
			<div class="CDEK-widget__delivery-type__box" id="#WID#cdek_delivery_types">
				<div class="CDEK-widget__delivery-type__title" id="#WID#cdek_delivery_type_title">
					<span class="CDEK_no-avail">#NO_AVAIL#</span>
					<span class="CDEK_choose" style="display:none;">#CHOOSE_TYPE_AVAIL#</span>
				</div>
				<div style="text-align: center; padding-bottom: 10px; display:none;" id="#WID#cdek_delivery_type_none">
					<span>#CHOOSE_OTHER_CITY#</span>
				</div>
			</div>
		</div>
		<!-- HERE -->
		<div class="CDEK-widget__courier-address">
			<div class="CDEK-widget__courier-address__box CDEK-widget__courier-address__box_close" id="#WID#cdek_courier_address">
				<div class="CDEK-widget__courier-address__title" id="#WID#cdek_courier_address_title">
					<span>#TYPE_ADDRESS#</span>
				</div>
				<div class="CDEK-widget__courier-address__item" data-delivery-address = "address">
					<input type="text" placeholder="#TYPE_ADDRESS_HERE#" id="#WID#cdek_courier_address_place"> <button class="CDEK-widget__courier-address__button">OK</button>
				</div>
			</div>
		</div>

		<div class="CDEK-widget__search-list">
			<div class="CDEK-widget__search-list__box">
				<ul id="#WID#city_list">
	...
	<div class="CDEK-widget__sidebar CDEK-widget__inaccessible" id="#WID#sidebar">
	</div>
	<div class="CDEK-widget__panel" id="#WID#panel">
        <div class="CDEK-widget__panel-list" id="#WID#pointlist"></div>
        <div class="CDEK-widget__panel-details" id="#WID#detail_panel"></div>
        <div class="CDEK-widget__panel-contacts">
            ...
            <div class="CDEK-widget__panel-content">
                <p>#H_QUESTIONS#</p>
                <p>
                    <a href="tel:88002501405" class="CDEK-widget__phone">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 444.41148 446.40002">
                            <path class="path"
                                  d="M374.456,293.506c-9.7-10.1-21.4-15.5-33.8-15.5-12.3,0-24.1,5.3-34.2,15.4l-31.6,31.5c-2.6-1.4-5.2-2.7-7.7-4-3.6-1.8-7-3.5-9.9-5.3-29.6-18.8-56.5-43.3-82.3-75-12.5-15.8-20.9-29.1-27-42.6,8.2-7.5,15.8-15.3,23.2-22.8,2.8-2.8,5.6-5.7,8.4-8.5,21-21,21-48.2,0-69.2l-27.3-27.3c-3.1-3.1-6.3-6.3-9.3-9.5-6-6.2-12.3-12.6-18.8-18.6-9.7-9.6-21.3-14.7-33.5-14.7s-24,5.1-34,14.7l-0.2.2-34,34.3a73.16053,73.16053,0,0,0-21.7,46.5c-2.4,29.2,6.2,56.4,12.8,74.2,16.2,43.7,40.4,84.2,76.5,127.6,43.8,52.3,96.5,93.6,156.7,122.7,23,10.9,53.7,23.8,88,26,2.1,0.1,4.3.2,6.3,0.2,23.1,0,42.5-8.3,57.7-24.8,0.1-.2.3-0.3,0.4-0.5,5.2-6.3,11.2-12,17.5-18.1,4.3-4.1,8.7-8.4,13-12.9,9.9-10.3,15.1-22.3,15.1-34.6,0-12.4-5.3-24.3-15.4-34.3Zm35.8,105.3c-0.1,0-.1.1,0,0-3.9,4.2-7.9,8-12.2,12.2a262.94685,262.94685,0,0,0-19.3,20c-10.1,10.8-22,15.9-37.6,15.9-1.5,0-3.1,0-4.6-.1-29.7-1.9-57.3-13.5-78-23.4-56.6-27.4-106.3-66.3-147.6-115.6-34.1-41.1-56.9-79.1-72-119.9-9.3-24.9-12.7-44.3-11.2-62.6a45.90488,45.90488,0,0,1,13.8-29.7l34.1-34.1c4.9-4.6,10.1-7.1,15.2-7.1,6.3,0,11.4,3.8,14.6,7l0.3,0.3c6.1,5.7,11.9,11.6,18,17.9,3.1,3.2,6.3,6.4,9.5,9.7l27.3,27.3c10.6,10.6,10.6,20.4,0,31-2.9,2.9-5.7,5.8-8.6,8.6-8.4,8.6-16.4,16.6-25.1,24.4a2.35721,2.35721,0,0,0-.5.5c-8.6,8.6-7,17-5.2,22.7l0.3,0.9c7.1,17.2,17.1,33.4,32.3,52.7l0.1,0.1c27.6,34,56.7,60.5,88.8,80.8a136.53623,136.53623,0,0,0,12.3,6.7c3.6,1.8,7,3.5,9.9,5.3,0.4,0.2.8,0.5,1.2,0.7a21.67755,21.67755,0,0,0,9.9,2.5c8.3,0,13.5-5.2,15.2-6.9l34.2-34.2c3.4-3.4,8.8-7.5,15.1-7.5,6.2,0,11.3,3.9,14.4,7.3l0.2,0.2,55.1,55.1C420.456,377.706,420.456,388.206,410.256,398.806Z"
                                  transform="translate(-0.34447 -27.40598)"></path>
                        </svg>
                        8 800 250-14-05
                    </a>
                </p>
                <p class="CDEK-widget__panel-content-mail">
                    <a href="mailto:sale@cdek.ru" target="_blank" class="CDEK-widget__mail">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 44.676">
                            <path class="path"
                                  d="M58,10.324H6a6.006,6.006,0,0,0-6,6V49a6.006,6.006,0,0,0,6,6H58a6.006,6.006,0,0,0,6-6V16.324A6.00668,6.00668,0,0,0,58,10.324Zm-0.982,4L32,32.367,6.982,14.324H57.018ZM58,51H6a2.00073,2.00073,0,0,1-2-2V17.107l26.83,19.35a2.004,2.004,0,0,0,2.34,0L60,17.107V49A2.00073,2.00073,0,0,1,58,51Z"
                                  transform="translate(0 -10.32397)"/>
                        </svg>
                        <span>sale@cdek.ru</span>
                    </a>
                </p>
            </div>
            <div class="CDEK-widget__developer">
                Разработано в
                <a href="https://ipolh.com/" target="_blank" class="IPOL-logo">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                         viewBox="0 0 351.414 45.4688">
                        <defs>
                            <clipPath id="IPOL-logo__clip-a" transform="translate(-220.293 -283.2656)">
                                <path class="IPOL-logo__path-a"
                                      d="M383.41109,285.4717a17.92737,17.92737,0,0,0-6.0595-2.0029,18.14886,18.14886,0,0,0-2.5938-.2081h-45.4736a18.14886,18.14886,0,0,0-2.5938.2081,17.96788,17.96788,0,0,0-15.4482,17.8339l-0.001,27.4366h9.3897s0.0009-26.3389.0009-27.4366a8.65226,8.65226,0,0,1,8.6534-8.6523h45.4716a8.6529,8.6529,0,0,1,8.6534,8.6523v27.4092h4.3105c0.1279,0.0108.2549,0.0274,0.3848,0.0274,0.1162,0,.2246-0.0205.3379-0.0274h4.3574s-0.001-26.9131-.001-27.4092A18.03477,18.03477,0,0,0,383.41109,285.4717Z"/>
                            </clipPath>
                            <linearGradient id="IPOL-logo__gradient-b" y1="22.7344" x2="351.414" y2="22.7344"
                                            gradientUnits="userSpaceOnUse">
                                <stop offset="0" stop-color="#ac3994"/>
                                <stop offset="1" stop-color="#11b9e7"/>
                            </linearGradient>
                            <clipPath id="IPOL-logo__clip-c" transform="translate(-220.293 -283.2656)">
                                <path class="IPOL-logo__path-a"
                                      d="M474.36129,285.4717h-0.0019a17.9352,17.9352,0,0,0-6.0596-2.0029,18.14537,18.14537,0,0,0-2.59279-.2081H420.23239a18.172,18.172,0,0,0-2.5947.2081,17.96887,17.96887,0,0,0-15.4463,17.8339v9.3907a18.19439,18.19439,0,0,0,18.041,18.0459H465.707a18.1599,18.1599,0,0,0,2.59279-.208,17.9235,17.9235,0,0,0,6.0596-2.0069h0.0019a18.03575,18.03575,0,0,0,9.38671-15.831v-9.3907A18.03694,18.03694,0,0,0,474.36129,285.4717Zm-0.0019,25.2217a8.65245,8.65245,0,0,1-8.6543,8.6523h-45.4727a8.6526,8.6526,0,0,1-8.6523-8.6523v-9.3907a8.6526,8.6526,0,0,1,8.6523-8.6523h45.4727a8.65245,8.65245,0,0,1,8.6543,8.6523v9.3907Z"/>
                            </clipPath>
                            <clipPath id="IPOL-logo__clip-e" transform="translate(-220.293 -283.2656)">
                                <path class="IPOL-logo__path-a"
                                      d="M518.42679,283.2607a18.18435,18.18435,0,0,0-17.0264,12.0674l-0.2832.8389-10.9688,32.5723h9.9063l10.3398-30.7002c0.0147-.0381.02351-0.0791,0.0391-0.1162a8.68575,8.68575,0,0,1,7.9932-5.2725h43.8906v36.0889H571.707V283.2607H518.42679Z"/>
                            </clipPath>
                            <clipPath id="IPOL-logo__clip-g" transform="translate(-220.293 -283.2656)">
                                <path class="IPOL-logo__path-a"
                                      d="M292.46289,319.3457h-54.126a8.65217,8.65217,0,0,1-8.6533-8.6523c0-.1739-0.0029-0.9844-0.0078-2.2198h0.0068V283.2705h-0.1045s-2.0498-.0039-4.582-0.0098h-0.0166c-2.5303.0059-4.6514,0.0098-4.6514,0.0098H220.293v25.2031h0.00389c-0.002,1.2266-.003,2.0342-0.003,2.2198a18.19664,18.19664,0,0,0,18.042,18.0459h63.5166V283.2607h-9.3896v36.085Z"/>
                            </clipPath>
                            <linearGradient id="IPOL-logo__gradient-h" x1="0.00049" y1="22.7344" x2="351.414" y2="22.7344"
                                            xlink:href="#IPOL-logo__gradient-b"/>
                        </defs>
                        <g class="IPOL-logo__group-b" style="clip-path: url(#IPOL-logo__clip-a);">
                            <rect class="IPOL-logo__rect-c" width="351.414" height="45.4688"/>
                        </g>
                        <g class="IPOL-logo__group-d" style="clip-path: url(#IPOL-logo__clip-c);">
                            <rect class="IPOL-logo__rect-c" width="351.414" height="45.4688"/>
                        </g>
                        <g class="IPOL-logo__group-e" style="clip-path: url(#IPOL-logo__clip-e);">
                            <rect class="IPOL-logo__rect-c" width="351.414" height="45.4688"/>
                        </g>
                        <g class="IPOL-logo__group-f" style="clip-path: url(#IPOL-logo__clip-g);">
                            <rect class="IPOL-logo__rect-g" x="0.00049" width="351.41351" height="45.4688"/>
                        </g>
                    </svg>
                </a>
            </div>
